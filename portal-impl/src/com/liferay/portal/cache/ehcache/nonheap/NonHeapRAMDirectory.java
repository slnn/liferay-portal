 ...
 * @author Tina Tian
 */
public class NonHeapRAMDirectory extends Directory implements Serializable {

	private static final long serialVersionUID = 1l;

	protected final Map<String,NonHeapRAMFile> fileMap =
		new ConcurrentHashMap<String,NonHeapRAMFile>();
	...
	*/
	public NonHeapRAMDirectory(Directory dir) throws IOException {
		this(dir, false);
	}

	private NonHeapRAMDirectory(Directory dir, boolean closeDir)
		throws IOException {
	...
	*/
	...
	public final long fileModified(String name) throws IOException {
		...
		NonHeapRAMFile file = fileMap.get(name);
	...
	*/
	...
	public void deleteFile(String name) throws IOException {
		...
		NonHeapRAMFile file = fileMap.remove(name);
	...
	public IndexOutput createOutput(String name) throws IOException {
		...
		NonHeapRAMFile file = newRAMFile();

		NonHeapRAMFile existing = fileMap.remove(name);
		...
		return new NonHeapRAMOutputStream(file);
	}
	...
	*/
	protected NonHeapRAMFile newRAMFile() {
		return new NonHeapRAMFile(this);
	}
	...
	public IndexInput openInput(String name) throws IOException {
		...
		return new NonHeapRAMInputStream(name, file);
	}
