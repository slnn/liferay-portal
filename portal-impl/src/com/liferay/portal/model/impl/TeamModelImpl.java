...
public class TeamModelImpl extends BaseModelImpl<Team> implements TeamModel {
	...
	void setTeamCacheModel(TeamCacheModel teamCacheModel) {
		_mvccVersion = teamCacheModel.mvccVersion;

		if (teamCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = teamCacheModel.uuid;
		}

		_teamId = teamCacheModel.teamId;
		_companyId = teamCacheModel.companyId;
		_userId = teamCacheModel.userId;

		if (teamCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = teamCacheModel.userName;
		}

		if (teamCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(teamCacheModel.createDate);
		}

		if (teamCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(teamCacheModel.modifiedDate);
		}

		_groupId = teamCacheModel.groupId;

		if (teamCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = teamCacheModel.name;
		}
		...
		if (teamCacheModel.description == null) {
			...
			_description = teamCacheModel.description;
		}

		if (teamCacheModel.lastPublishDate != Long.MIN_VALUE) {
			_lastPublishDate = new Date(teamCacheModel.lastPublishDate);
		}
	}
