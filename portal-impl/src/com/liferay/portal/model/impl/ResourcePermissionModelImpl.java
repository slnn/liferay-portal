...
public class ResourcePermissionModelImpl
	...
	void setResourcePermissionCacheModel(
		ResourcePermissionCacheModel resourcePermissionCacheModel) {

		_mvccVersion = resourcePermissionCacheModel.mvccVersion;
		_resourcePermissionId =
			resourcePermissionCacheModel.resourcePermissionId;
		_companyId = resourcePermissionCacheModel.companyId;

		if (resourcePermissionCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = resourcePermissionCacheModel.name;
		}

		_scope = resourcePermissionCacheModel.scope;

		if (resourcePermissionCacheModel.primKey == null) {
			_primKey = "";
		}
		else {
			_primKey = resourcePermissionCacheModel.primKey;
		}

		_primKeyId = resourcePermissionCacheModel.primKeyId;
		_roleId = resourcePermissionCacheModel.roleId;
		_ownerId = resourcePermissionCacheModel.ownerId;
		_actionIds = resourcePermissionCacheModel.actionIds;
		_viewActionId = resourcePermissionCacheModel.viewActionId;
	}
