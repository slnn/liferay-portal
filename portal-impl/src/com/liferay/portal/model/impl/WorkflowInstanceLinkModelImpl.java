...
public class WorkflowInstanceLinkModelImpl
	...
	void setWorkflowInstanceLinkCacheModel(
		WorkflowInstanceLinkCacheModel workflowInstanceLinkCacheModel) {

		_mvccVersion = workflowInstanceLinkCacheModel.mvccVersion;
		_workflowInstanceLinkId =
			workflowInstanceLinkCacheModel.workflowInstanceLinkId;
		_groupId = workflowInstanceLinkCacheModel.groupId;
		_companyId = workflowInstanceLinkCacheModel.companyId;
		_userId = workflowInstanceLinkCacheModel.userId;

		if (workflowInstanceLinkCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = workflowInstanceLinkCacheModel.userName;
		}

		if (workflowInstanceLinkCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(workflowInstanceLinkCacheModel.createDate);
		}

		if (workflowInstanceLinkCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(
				workflowInstanceLinkCacheModel.modifiedDate);
		}

		_classNameId = workflowInstanceLinkCacheModel.classNameId;
		_classPK = workflowInstanceLinkCacheModel.classPK;
		_workflowInstanceId = workflowInstanceLinkCacheModel.workflowInstanceId;
	}
