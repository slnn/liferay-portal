...
public class ServiceComponentModelImpl
	...
	void setServiceComponentCacheModel(
		ServiceComponentCacheModel serviceComponentCacheModel) {

		_mvccVersion = serviceComponentCacheModel.mvccVersion;
		_serviceComponentId = serviceComponentCacheModel.serviceComponentId;

		if (serviceComponentCacheModel.buildNamespace == null) {
			_buildNamespace = "";
		}
		else {
			_buildNamespace = serviceComponentCacheModel.buildNamespace;
		}

		_buildNumber = serviceComponentCacheModel.buildNumber;
		_buildDate = serviceComponentCacheModel.buildDate;

		if (serviceComponentCacheModel.data == null) {
			_data = "";
		}
		else {
			_data = serviceComponentCacheModel.data;
		}
	}
