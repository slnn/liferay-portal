...
public class ListTypeModelImpl
	...
	void setListTypeCacheModel(ListTypeCacheModel listTypeCacheModel) {
		_mvccVersion = listTypeCacheModel.mvccVersion;
		_listTypeId = listTypeCacheModel.listTypeId;

		if (listTypeCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = listTypeCacheModel.name;
		}
