...
public class CompanyModelImpl
	...
	void setCompanyCacheModel(CompanyCacheModel companyCacheModel) {
		_mvccVersion = companyCacheModel.mvccVersion;
		_companyId = companyCacheModel.companyId;
		_accountId = companyCacheModel.accountId;

		if (companyCacheModel.webId == null) {
			_webId = "";
		}
		else {
			_webId = companyCacheModel.webId;
		}
		...
		if (companyCacheModel.homeURL == null) {
			...
			_homeURL = companyCacheModel.homeURL;
		}

		_logoId = companyCacheModel.logoId;
		_system = companyCacheModel.system;
		_maxUsers = companyCacheModel.maxUsers;
		_active = companyCacheModel.active;

		setCompanySecurityBag(companyCacheModel._companySecurityBag);

		setKeyObj(companyCacheModel._keyObj);

		setVirtualHostname(companyCacheModel._virtualHostname);
	}
