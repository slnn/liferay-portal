...
public class CountryModelImpl
	...
	void setCountryCacheModel(CountryCacheModel countryCacheModel) {
		_mvccVersion = countryCacheModel.mvccVersion;
		_countryId = countryCacheModel.countryId;

		if (countryCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = countryCacheModel.name;
		}
		...
		if (countryCacheModel.number == null) {
			...
			_number = countryCacheModel.number;
		}
		...
		if (countryCacheModel.idd == null) {
			...
			_idd = countryCacheModel.idd;
		}

		_zipRequired = countryCacheModel.zipRequired;
		_active = countryCacheModel.active;
	}
