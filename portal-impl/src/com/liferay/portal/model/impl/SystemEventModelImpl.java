...
public class SystemEventModelImpl
	...
	void setSystemEventCacheModel(SystemEventCacheModel systemEventCacheModel) {
		_mvccVersion = systemEventCacheModel.mvccVersion;
		_systemEventId = systemEventCacheModel.systemEventId;
		_groupId = systemEventCacheModel.groupId;
		_companyId = systemEventCacheModel.companyId;
		_userId = systemEventCacheModel.userId;

		if (systemEventCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = systemEventCacheModel.userName;
		}

		if (systemEventCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(systemEventCacheModel.createDate);
		}

		_classNameId = systemEventCacheModel.classNameId;
		_classPK = systemEventCacheModel.classPK;

		if (systemEventCacheModel.classUuid == null) {
			_classUuid = "";
		}
		else {
			_classUuid = systemEventCacheModel.classUuid;
		}

		_referrerClassNameId = systemEventCacheModel.referrerClassNameId;
		_parentSystemEventId = systemEventCacheModel.parentSystemEventId;
		_systemEventSetKey = systemEventCacheModel.systemEventSetKey;
		_type = systemEventCacheModel.type;

		if (systemEventCacheModel.extraData == null) {
			_extraData = "";
		}
		else {
			_extraData = systemEventCacheModel.extraData;
		}
	}
