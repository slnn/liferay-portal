...
public class ResourceBlockModelImpl
	...
	void setResourceBlockCacheModel(
		ResourceBlockCacheModel resourceBlockCacheModel) {

		_mvccVersion = resourceBlockCacheModel.mvccVersion;
		_resourceBlockId = resourceBlockCacheModel.resourceBlockId;
		_companyId = resourceBlockCacheModel.companyId;
		_groupId = resourceBlockCacheModel.groupId;

		if (resourceBlockCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = resourceBlockCacheModel.name;
		}

		if (resourceBlockCacheModel.permissionsHash == null) {
			_permissionsHash = "";
		}
		else {
			_permissionsHash = resourceBlockCacheModel.permissionsHash;
		}

		_referenceCount = resourceBlockCacheModel.referenceCount;
	}
