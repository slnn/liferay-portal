...
public class RepositoryEntryModelImpl
	...
	void setRepositoryEntryCacheModel(
		RepositoryEntryCacheModel repositoryEntryCacheModel) {

		_mvccVersion = repositoryEntryCacheModel.mvccVersion;

		if (repositoryEntryCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = repositoryEntryCacheModel.uuid;
		}

		_repositoryEntryId = repositoryEntryCacheModel.repositoryEntryId;
		_groupId = repositoryEntryCacheModel.groupId;
		_companyId = repositoryEntryCacheModel.companyId;
		_userId = repositoryEntryCacheModel.userId;

		if (repositoryEntryCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = repositoryEntryCacheModel.userName;
		}

		if (repositoryEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(repositoryEntryCacheModel.createDate);
		}

		if (repositoryEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(repositoryEntryCacheModel.modifiedDate);
		}

		_repositoryId = repositoryEntryCacheModel.repositoryId;

		if (repositoryEntryCacheModel.mappedId == null) {
			_mappedId = "";
		}
		else {
			_mappedId = repositoryEntryCacheModel.mappedId;
		}

		_manualCheckInRequired =
			repositoryEntryCacheModel.manualCheckInRequired;

		if (repositoryEntryCacheModel.lastPublishDate != Long.MIN_VALUE) {
