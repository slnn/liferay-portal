...
public class PortletModelImpl
	...
	void setPortletCacheModel(PortletCacheModel portletCacheModel) {
		_mvccVersion = portletCacheModel.mvccVersion;
		_id = portletCacheModel.id;
		_companyId = portletCacheModel.companyId;

		if (portletCacheModel.portletId == null) {
			_portletId = "";
		}
		else {
			_portletId = portletCacheModel.portletId;
		}
		...
		if (portletCacheModel.roles == null) {
			...
			_roles = portletCacheModel.roles;
		}

		_active = portletCacheModel.active;
	}
