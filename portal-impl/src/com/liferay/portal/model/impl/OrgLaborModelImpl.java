...
public class OrgLaborModelImpl
	...
	void setOrgLaborCacheModel(OrgLaborCacheModel orgLaborCacheModel) {
		_mvccVersion = orgLaborCacheModel.mvccVersion;
		_orgLaborId = orgLaborCacheModel.orgLaborId;
		_companyId = orgLaborCacheModel.companyId;
		_organizationId = orgLaborCacheModel.organizationId;
		_typeId = orgLaborCacheModel.typeId;
		_sunOpen = orgLaborCacheModel.sunOpen;
		_sunClose = orgLaborCacheModel.sunClose;
		_monOpen = orgLaborCacheModel.monOpen;
		_monClose = orgLaborCacheModel.monClose;
		_tueOpen = orgLaborCacheModel.tueOpen;
		_tueClose = orgLaborCacheModel.tueClose;
		_wedOpen = orgLaborCacheModel.wedOpen;
		_wedClose = orgLaborCacheModel.wedClose;
		_thuOpen = orgLaborCacheModel.thuOpen;
		_thuClose = orgLaborCacheModel.thuClose;
		_friOpen = orgLaborCacheModel.friOpen;
		_friClose = orgLaborCacheModel.friClose;
		_satOpen = orgLaborCacheModel.satOpen;
		_satClose = orgLaborCacheModel.satClose;
	}
