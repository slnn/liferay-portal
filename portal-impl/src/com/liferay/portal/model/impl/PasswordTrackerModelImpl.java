...
public class PasswordTrackerModelImpl
	...
	void setPasswordTrackerCacheModel(
		PasswordTrackerCacheModel passwordTrackerCacheModel) {

		_mvccVersion = passwordTrackerCacheModel.mvccVersion;
		_passwordTrackerId = passwordTrackerCacheModel.passwordTrackerId;
		_companyId = passwordTrackerCacheModel.companyId;
		_userId = passwordTrackerCacheModel.userId;

		if (passwordTrackerCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(passwordTrackerCacheModel.createDate);
		}
		...
		if (passwordTrackerCacheModel.password == null) {
			...
			_password = passwordTrackerCacheModel.password;
		}
	}
