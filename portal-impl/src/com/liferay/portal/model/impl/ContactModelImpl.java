...
public class ContactModelImpl
	...
	void setContactCacheModel(ContactCacheModel contactCacheModel) {
		_mvccVersion = contactCacheModel.mvccVersion;
		_contactId = contactCacheModel.contactId;
		_companyId = contactCacheModel.companyId;
		_userId = contactCacheModel.userId;

		if (contactCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = contactCacheModel.userName;
		}

		if (contactCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(contactCacheModel.createDate);
		}

		if (contactCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(contactCacheModel.modifiedDate);
		}

		_classNameId = contactCacheModel.classNameId;
		_classPK = contactCacheModel.classPK;
		_accountId = contactCacheModel.accountId;
		_parentContactId = contactCacheModel.parentContactId;

		if (contactCacheModel.emailAddress == null) {
			_emailAddress = "";
		}
		else {
			_emailAddress = contactCacheModel.emailAddress;
		}
		...
		if (contactCacheModel.firstName == null) {
			...
			_firstName = contactCacheModel.firstName;
		}
		...
		if (contactCacheModel.middleName == null) {
			...
			_middleName = contactCacheModel.middleName;
		}
		...
		if (contactCacheModel.lastName == null) {
			...
			_lastName = contactCacheModel.lastName;
		}

		_prefixId = contactCacheModel.prefixId;
		_suffixId = contactCacheModel.suffixId;
		_male = contactCacheModel.male;

		if (contactCacheModel.birthday != Long.MIN_VALUE) {
			_birthday = new Date(contactCacheModel.birthday);
		}
		...
		if (contactCacheModel.smsSn == null) {
			...
			_smsSn = contactCacheModel.smsSn;
		}
		...
		if (contactCacheModel.facebookSn == null) {
			...
			_facebookSn = contactCacheModel.facebookSn;
		}
		...
		if (contactCacheModel.jabberSn == null) {
			...
			_jabberSn = contactCacheModel.jabberSn;
		}
		...
		if (contactCacheModel.skypeSn == null) {
			...
			_skypeSn = contactCacheModel.skypeSn;
		}
		...
		if (contactCacheModel.twitterSn == null) {
			...
			_twitterSn = contactCacheModel.twitterSn;
		}
		...
		if (contactCacheModel.employeeStatusId == null) {
			...
			_employeeStatusId = contactCacheModel.employeeStatusId;
		}
		...
		if (contactCacheModel.employeeNumber == null) {
			...
			_employeeNumber = contactCacheModel.employeeNumber;
		}
		...
		if (contactCacheModel.jobTitle == null) {
			...
			_jobTitle = contactCacheModel.jobTitle;
		}
		...
		if (contactCacheModel.jobClass == null) {
			...
			_jobClass = contactCacheModel.jobClass;
		}
		...
		if (contactCacheModel.hoursOfOperation == null) {
			...
			_hoursOfOperation = contactCacheModel.hoursOfOperation;
		}
	}
