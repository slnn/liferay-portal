...
public class ReleaseModelImpl
	...
	void setReleaseCacheModel(ReleaseCacheModel releaseCacheModel) {
		_mvccVersion = releaseCacheModel.mvccVersion;
		_releaseId = releaseCacheModel.releaseId;

		if (releaseCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(releaseCacheModel.createDate);
		}

		if (releaseCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(releaseCacheModel.modifiedDate);
		}
		...
		if (releaseCacheModel.servletContextName == null) {
			...
			_servletContextName = releaseCacheModel.servletContextName;
		}

		if (releaseCacheModel.schemaVersion == null) {
			_schemaVersion = "";
		}
		else {
			_schemaVersion = releaseCacheModel.schemaVersion;
		}

		_buildNumber = releaseCacheModel.buildNumber;

		if (releaseCacheModel.buildDate != Long.MIN_VALUE) {
			_buildDate = new Date(releaseCacheModel.buildDate);
		}

		_verified = releaseCacheModel.verified;
		_state = releaseCacheModel.state;

		if (releaseCacheModel.testString == null) {
			_testString = "";
		}
		else {
			_testString = releaseCacheModel.testString;
		}
	}
