...
public class ResourceActionModelImpl
	...
	void setResourceActionCacheModel(
		ResourceActionCacheModel resourceActionCacheModel) {

		_mvccVersion = resourceActionCacheModel.mvccVersion;
		_resourceActionId = resourceActionCacheModel.resourceActionId;

		if (resourceActionCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = resourceActionCacheModel.name;
		}
		...
		if (resourceActionCacheModel.actionId == null) {
			...
			_actionId = resourceActionCacheModel.actionId;
		}

		_bitwiseValue = resourceActionCacheModel.bitwiseValue;
	}
