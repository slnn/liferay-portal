...
public class ClassNameModelImpl
	...
	void setClassNameCacheModel(ClassNameCacheModel classNameCacheModel) {
		_mvccVersion = classNameCacheModel.mvccVersion;
		_classNameId = classNameCacheModel.classNameId;

		if (classNameCacheModel.value == null) {
			_value = "";
		}
		else {
			_value = classNameCacheModel.value;
		}
	}
