...
public class ImageModelImpl extends BaseModelImpl<Image> implements ImageModel {
	...
	void setImageCacheModel(ImageCacheModel imageCacheModel) {
		_mvccVersion = imageCacheModel.mvccVersion;
		_imageId = imageCacheModel.imageId;
		_companyId = imageCacheModel.companyId;

		if (imageCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(imageCacheModel.modifiedDate);
		}
		...
		if (imageCacheModel.type == null) {
			...
			_type = imageCacheModel.type;
		}

		_height = imageCacheModel.height;
		_width = imageCacheModel.width;
		_size = imageCacheModel.size;
	}
