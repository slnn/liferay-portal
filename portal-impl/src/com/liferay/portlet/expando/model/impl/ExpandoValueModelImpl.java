...
public class ExpandoValueModelImpl
	...
	void setExpandoValueCacheModel(
		ExpandoValueCacheModel expandoValueCacheModel) {

		_valueId = expandoValueCacheModel.valueId;
		_companyId = expandoValueCacheModel.companyId;
		_tableId = expandoValueCacheModel.tableId;
		_columnId = expandoValueCacheModel.columnId;
		_rowId = expandoValueCacheModel.rowId;
		_classNameId = expandoValueCacheModel.classNameId;
		_classPK = expandoValueCacheModel.classPK;

		if (expandoValueCacheModel.data == null) {
			_data = "";
		}
		else {
			_data = expandoValueCacheModel.data;
		}
	}
