...
public class ExpandoTableModelImpl
	...
	void setExpandoTableCacheModel(
		ExpandoTableCacheModel expandoTableCacheModel) {

		_tableId = expandoTableCacheModel.tableId;
		_companyId = expandoTableCacheModel.companyId;
		_classNameId = expandoTableCacheModel.classNameId;

		if (expandoTableCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = expandoTableCacheModel.name;
		}
	}
