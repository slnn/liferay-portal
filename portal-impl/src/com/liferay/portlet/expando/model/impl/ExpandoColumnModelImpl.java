...
public class ExpandoColumnModelImpl
	...
	void setExpandoColumnCacheModel(
		ExpandoColumnCacheModel expandoColumnCacheModel) {

		_columnId = expandoColumnCacheModel.columnId;
		_companyId = expandoColumnCacheModel.companyId;
		_tableId = expandoColumnCacheModel.tableId;

		if (expandoColumnCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = expandoColumnCacheModel.name;
		}

		_type = expandoColumnCacheModel.type;

		if (expandoColumnCacheModel.defaultData == null) {
			_defaultData = "";
		}
		else {
			_defaultData = expandoColumnCacheModel.defaultData;
		}
		...
		if (expandoColumnCacheModel.typeSettings == null) {
			...
			_typeSettings = expandoColumnCacheModel.typeSettings;
		}
	}
