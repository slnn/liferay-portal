...
public class DLFileEntryLocalServiceImpl
	...
	public DLFileEntry deleteFileEntry(DLFileEntry dlFileEntry)
		...
		for (DLFileVersion dlFileVersion : dlFileVersions) {
			...
			ExpandoLocalServiceBridgeUtil.deleteRows(
		...
		ExpandoLocalServiceBridgeUtil.deleteRows(dlFileEntry.getFileEntryId());
	...
	private void _copyExpandoRowModifiedDate(
		...
		ExpandoTable expandoTable =
			ExpandoLocalServiceBridgeUtil.fetchDefaultTable(
		...
		ExpandoRow sourceExpandoRow = ExpandoLocalServiceBridgeUtil.fetchRow(
		...
		ExpandoRow targetExpandoRow = ExpandoLocalServiceBridgeUtil.fetchRow(
		...
		ExpandoLocalServiceBridgeUtil.updateExpandoRow(targetExpandoRow);
	}
