...
public class AnnouncementsDeliveryModelImpl
	...
	void setAnnouncementsDeliveryCacheModel(
		AnnouncementsDeliveryCacheModel announcementsDeliveryCacheModel) {

		_deliveryId = announcementsDeliveryCacheModel.deliveryId;
		_companyId = announcementsDeliveryCacheModel.companyId;
		_userId = announcementsDeliveryCacheModel.userId;

		if (announcementsDeliveryCacheModel.type == null) {
			_type = "";
		}
		else {
			_type = announcementsDeliveryCacheModel.type;
		}

		_email = announcementsDeliveryCacheModel.email;
		_sms = announcementsDeliveryCacheModel.sms;
		_website = announcementsDeliveryCacheModel.website;
	}
