...
public class AnnouncementsEntryModelImpl
	...
	void setAnnouncementsEntryCacheModel(
		AnnouncementsEntryCacheModel announcementsEntryCacheModel) {
		...
		if (announcementsEntryCacheModel.uuid == null) {
			...
			_uuid = announcementsEntryCacheModel.uuid;
		}

		_entryId = announcementsEntryCacheModel.entryId;
		_companyId = announcementsEntryCacheModel.companyId;
		_userId = announcementsEntryCacheModel.userId;

		if (announcementsEntryCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = announcementsEntryCacheModel.userName;
		}

		if (announcementsEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(announcementsEntryCacheModel.createDate);
		}

		if (announcementsEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(announcementsEntryCacheModel.modifiedDate);
		}

		_classNameId = announcementsEntryCacheModel.classNameId;
		_classPK = announcementsEntryCacheModel.classPK;

		if (announcementsEntryCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = announcementsEntryCacheModel.title;
		}
		...
		if (announcementsEntryCacheModel.content == null) {
			...
			_content = announcementsEntryCacheModel.content;
		}
		...
		if (announcementsEntryCacheModel.url == null) {
			...
			_url = announcementsEntryCacheModel.url;
		}
		...
		if (announcementsEntryCacheModel.type == null) {
			...
			_type = announcementsEntryCacheModel.type;
		}

		if (announcementsEntryCacheModel.displayDate != Long.MIN_VALUE) {
			_displayDate = new Date(announcementsEntryCacheModel.displayDate);
		}

		if (announcementsEntryCacheModel.expirationDate != Long.MIN_VALUE) {
			_expirationDate = new Date(
				announcementsEntryCacheModel.expirationDate);
		}

		_priority = announcementsEntryCacheModel.priority;
		_alert = announcementsEntryCacheModel.alert;
	}
