...
public class SocialRequestModelImpl
	...
	void setSocialRequestCacheModel(
		SocialRequestCacheModel socialRequestCacheModel) {
		...
		if (socialRequestCacheModel.uuid == null) {
			...
			_uuid = socialRequestCacheModel.uuid;
		}

		_requestId = socialRequestCacheModel.requestId;
		_groupId = socialRequestCacheModel.groupId;
		_companyId = socialRequestCacheModel.companyId;
		_userId = socialRequestCacheModel.userId;
		_createDate = socialRequestCacheModel.createDate;
		_modifiedDate = socialRequestCacheModel.modifiedDate;
		_classNameId = socialRequestCacheModel.classNameId;
		_classPK = socialRequestCacheModel.classPK;
		_type = socialRequestCacheModel.type;

		if (socialRequestCacheModel.extraData == null) {
			_extraData = "";
		}
		else {
			_extraData = socialRequestCacheModel.extraData;
		}

		_receiverUserId = socialRequestCacheModel.receiverUserId;
		_status = socialRequestCacheModel.status;
	}
