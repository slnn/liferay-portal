...
public class SocialActivitySetModelImpl
	...
	void setSocialActivitySetCacheModel(
		SocialActivitySetCacheModel socialActivitySetCacheModel) {

		_activitySetId = socialActivitySetCacheModel.activitySetId;
		_groupId = socialActivitySetCacheModel.groupId;
		_companyId = socialActivitySetCacheModel.companyId;
		_userId = socialActivitySetCacheModel.userId;
		_createDate = socialActivitySetCacheModel.createDate;
		_modifiedDate = socialActivitySetCacheModel.modifiedDate;
		_classNameId = socialActivitySetCacheModel.classNameId;
		_classPK = socialActivitySetCacheModel.classPK;
		_type = socialActivitySetCacheModel.type;

		if (socialActivitySetCacheModel.extraData == null) {
			_extraData = "";
		}
		else {
			_extraData = socialActivitySetCacheModel.extraData;
		}

		_activityCount = socialActivitySetCacheModel.activityCount;
	}
