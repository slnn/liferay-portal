...
public class RequestDispatcherAttributeNames {
	...
	public static boolean contains(String name) {
		if (name.startsWith("javax.") && _attributeNames.contains(name)) {
			return true;
		}
	...
	private static final Set<String> _attributeNames;

	static {
		_attributeNames = _createConstantSet(
			1024, JavaConstants.JAVAX_SERVLET_FORWARD_CONTEXT_PATH,
