...
public class BenchmarksPropsValues {
	...
	public static final int MAX_VIRTUAL_INSTANCE_BLOGS_ENTRY_COMMENT_COUNT =
		GetterUtil.getInteger(
			PropertiesHolder._get(
				BenchmarksPropsKeys.
	...
	public static final int MAX_VIRTUAL_INSTANCE_MB_MESSAGE_COUNT =
		GetterUtil.getInteger(
			PropertiesHolder._get(
				BenchmarksPropsKeys.MAX_VIRTUAL_INSTANCE_MB_MESSAGE_COUNT));

	public static final int MAX_VIRTUAL_INSTANCE_MB_THREAD_COUNT =
		GetterUtil.getInteger(
			PropertiesHolder._get(
				BenchmarksPropsKeys.MAX_VIRTUAL_INSTANCE_MB_THREAD_COUNT));
