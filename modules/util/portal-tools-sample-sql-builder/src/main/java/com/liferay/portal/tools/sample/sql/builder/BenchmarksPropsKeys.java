...
public interface BenchmarksPropsKeys {
	...
	public static final String MAX_VIRTUAL_INSTANCE_MB_MESSAGE_COUNT =
		"sample.sql.max.virtual.instance.mb.message.count";

	public static final String MAX_VIRTUAL_INSTANCE_MB_THREAD_COUNT =
		"sample.sql.max.virtual.instance.mb.thread.count";

	public static final String MAX_VIRTUAL_INSTANCE_USER_COUNT =
		"sample.sql.max.virtual.instance.user.count";

	public static final String MAX_VIRTUAL_INSTANCE_WIKI_PAGE_COMMENT_COUNT =
		"sample.sql.max.virtual.instance.wiki.page.comment.count";
