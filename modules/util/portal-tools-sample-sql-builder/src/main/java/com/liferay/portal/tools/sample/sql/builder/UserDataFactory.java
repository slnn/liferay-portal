...
public class UserDataFactory extends BaseDataFactory {
	...
	private void _initAccountModel() {
		...
		_accountModel.setAccountId(initRuntimeContext.getAccountId());
		_accountModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	private void _initCompanyModel() {
		...
		_companyModel.setCompanyId(initRuntimeContext.getCompanyId());
		_companyModel.setAccountId(initRuntimeContext.getAccountId());
	...
	private void _initVirtualHostModel() {
		...
		_virtualHostModel.setCompanyId(initRuntimeContext.getCompanyId());
		_virtualHostModel.setHostname(
