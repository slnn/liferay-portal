...
public class DataFactory {
	...
	public PortalPreferencesModel newPortalPreferencesModel() {
	...
	public PortalPreferenceValueModel newPortalPreferenceValueModel(
		...
		portalPreferenceValueModel.setKey("com.liferay.site.util_recentGroups");
		portalPreferenceValueModel.setLargeValue("");
		portalPreferenceValueModel.setNamespace(SessionClicks.class.getName());
	...
	protected PortalPreferencesModel newPortalPreferencesModel(
