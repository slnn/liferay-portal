...
public class DataFactory extends BaseDataFactory {
	...
	public DataFactory(
		...
		_userDataFactory = new UserDataFactory(
	...
	public void initAssetTagModels() {
		...
		for (int i = 1; i <= maxGroupsCount; i++) {
			...
			for (int j = 0; j < maxAssetTagCount; j++) {
				...
				assetTagModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public BlogsStatsUserModel newBlogsStatsUserModel(long groupId) {
		...
		blogsStatsUserModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public DDLRecordModel newDDLRecordModel(
		...
		ddlRecordModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public DDLRecordSetModel newDDLRecordSetModel(
		...
		ddlRecordSetModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public DDLRecordVersionModel newDDLRecordVersionModel(
		...
		ddlRecordVersionModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public DDMStructureVersionModel newDDMStructureVersionModel(
		...
		ddmStructureVersionModel.setCompanyId(
			initRuntimeContext.getCompanyId());
	...
	public DDMTemplateLinkModel newDDMTemplateLinkModel(
		...
		ddmTemplateLinkModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public DLFileVersionModel newDLFileVersionModel(
		...
		dlFileVersionModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public FriendlyURLEntryModel newFriendlyURLEntryModel(
		...
		friendlyURLEntryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public JournalArticleModel newJournalArticleModel(
		...
		journalArticleModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public LayoutModel newLayoutModel(
		...
		layoutModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public MBDiscussionModel newMBDiscussionModel(
		...
		mbDiscussionModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public MBMailingListModel newMBMailingListModel(
		...
		mbMailingListModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	public MBThreadFlagModel newMBThreadFlagModel(MBThreadModel mbThreadModel) {
		...
		mbThreadFlagModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected AssetCategoryModel newAssetCategoryModel(
		...
		assetCategoryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected AssetEntryModel newAssetEntryModel(
		...
		assetEntryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected AssetVocabularyModel newAssetVocabularyModel(
		...
		assetVocabularyModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected BlogsEntryModel newBlogsEntryModel(long groupId, int index) {
		...
		blogsEntryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DDMContentModel newDDMContentModel(
		...
		ddmContentModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DDMStructureLayoutModel newDDMStructureLayoutModel(
		...
		ddmStructureLayoutModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DDMStructureModel newDDMStructureModel(
		...
		ddmStructureModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DDMTemplateModel newDDMTemplateModel(
		...
		ddmTemplateModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DLFileEntryModel newDlFileEntryModel(
		...
		dlFileEntryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected DLFolderModel newDLFolderModel(
		...
		dlFolderModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected LayoutSetModel newLayoutSetModel(
		...
		layoutSetModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected MBCategoryModel newMBCategoryModel(long groupId, int index) {
		...
		mbCategoryModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected MBMessageModel newMBMessageModel(
		...
		mBMessageModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected MBThreadModel newMBThreadModel(
		...
		mbThreadModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected SocialActivityModel newSocialActivityModel(
		...
		socialActivityModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected SubscriptionModel newSubscriptionModel(
		...
		subscriptionModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected WikiNodeModel newWikiNodeModel(long groupId, int index) {
		...
		wikiNodeModel.setCompanyId(initRuntimeContext.getCompanyId());
	...
	protected WikiPageModel newWikiPageModel(
		...
		wikiPageModel.setCompanyId(initRuntimeContext.getCompanyId());
