...
<@insertGroup _groupModel=dataFactory.newCommerceCatalogGroupModel(dataFactory.commerceCatalogModel) />

<@insertGroup _groupModel=dataFactory.newCommerceChannelGroupModel(dataFactory.commerceChannelModel) />