...
<#list ddlRecordSetCounts as ddlRecordSetCount>
	...
	<#list ddlRecordCounts as ddlRecordCount>
		...
		${csvFileWriter.write("dynamicDataList", companyModel.webId + "," + ddlRecordModel.groupId + "," + layoutName + "," + portletId + "," + ddlRecordSetModel.recordSetId + "," + ddlRecordModel.recordId + "\n")}
	</#list>
