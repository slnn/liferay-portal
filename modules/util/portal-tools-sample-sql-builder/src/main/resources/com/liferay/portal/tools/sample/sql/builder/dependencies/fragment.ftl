...
<#assign
	contentPageCounts = dataFactory.getSequence(dataFactory.maxContentPageCount)
...
<#list contentPageCounts as contentPageCount>
	<#assign contentLayoutModel = dataFactory.newContentLayoutModel(groupId, groupId + "_journal_article_" + contentPageCount, "web_content") />
	...
	<#list contentPageJournalArticleCounts as contentPagejournalArticleCount>
		...
		<#assign versionCounts = dataFactory.getSequence(dataFactory.maxContentPageJournalArticleVersionCount) />
		...
		<#list versionCounts as versionCount>
			...
			<#if versionCount = dataFactory.maxContentPageJournalArticleVersionCount>
				<@insertAssetEntry
