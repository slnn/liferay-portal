<#list dataFactory.getSequence(dataFactory.maxCPDefinitionAttachmentTypeImageCount) as cpDefinitionAttachmentTypeImageCount>
	<#assign
		...
		dlFileEntryModel = dataFactory.newDlFileEntryModel(dlFolderModel, "TestFile" + cpAttachmentFileEntryModel.CPAttachmentFileEntryId, "jpeg", "image/jpeg", cpAttachmentFileEntryModel.fileEntryId, sampleUserModel)
...
<#list dataFactory.getSequence(dataFactory.maxCPDefinitionAttachmentTypePDFCount) as cpDefinitionAttachmentTypePDFCount>
	<#assign
		...
		dlFileEntryModel = dataFactory.newDlFileEntryModel(dlFolderModel, "TestFile" + cpAttachmentFileEntryModel.CPAttachmentFileEntryId, "pdf", "application/pdf", cpAttachmentFileEntryModel.fileEntryId, sampleUserModel)
