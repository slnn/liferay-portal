	...
	<#if _dlFolderDepth <= dataFactory.maxDLFolderDepth>
		...
		<#list dlFolderModels as dlFolderModel>
			...
			<#list dlFileEntryModels as dlFileEntryModel>
				...
				${csvFileWriter.write("documentLibrary", companyModelList[1] + "," + dlFileEntryModel.uuid + "," + dlFolderModel.folderId + "," + dlFileEntryModel.name + "," + dlFileEntryModel.fileEntryId + "," + dlFileEntryModel.fileName + "," + _groupId + "\n")}
			</#list>
