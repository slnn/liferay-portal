...
>
	...
	${resourcePermissionDataFactory.toInsertSQL(dataFactory.newDDMStorageLinkModel(_ddmStorageLinkId, ddmContentModel, _ddmStructureId))}
</#macro>
	...
	<#if _dlFolderDepth <= initPropertiesContext.maxDLFolderDepth>
		...
		<#list dlFolderModels as dlFolderModel>
			...
			<#list dlFileEntryModels as dlFileEntryModel>
				...
				${resourcePermissionDataFactory.toInsertSQL(dataFactory.newSocialActivityModel(dlFileEntryModel))}
				...
				${resourcePermissionDataFactory.toInsertSQL(dataFactory.newDDMStructureLinkModel(dlFileEntryMetadataModel))}
...
>
	...
	${resourcePermissionDataFactory.toInsertSQL(dataFactory.newLayoutFriendlyURLModel(_layoutModel))}
</#macro>
...
>
	...
	${resourcePermissionDataFactory.toInsertSQL(dataFactory.newMBDiscussionModel(_groupId, _classNameId, _classPK, _mbThreadId))}
</#macro>
