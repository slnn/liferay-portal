...
<#list groupIds as groupId>
	${resourcePermissionDataFactory.toInsertSQL(dataFactory.newBlogsStatsUserModel(groupId))}

	${resourcePermissionDataFactory.toInsertSQL(dataFactory.newMBStatsUserModel(groupId))}
</#list>