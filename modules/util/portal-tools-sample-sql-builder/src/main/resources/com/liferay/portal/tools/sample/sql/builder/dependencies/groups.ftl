...
<#list userDataFactory.newGroupModels() as groupModel>
	...
	<@insertHomePageContentLayout _layoutModels=layoutDataFactory.newHomePageLayoutModels(groupId) />
...
<@insertHomePageContentLayout _layoutModels=layoutDataFactory.newHomePageLayoutModels(guestGroupModel.groupId) />