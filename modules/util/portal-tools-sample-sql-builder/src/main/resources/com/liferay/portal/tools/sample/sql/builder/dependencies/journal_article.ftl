<#assign
	...
	resourcePermissionModels = dataFactory.newResourcePermissionModels("com.liferay.journal", groupId, sampleUserModel, dataFactory.guestRoleModel, dataFactory.ownerRoleModel, dataFactory.siteMemberRoleModel)
/>
