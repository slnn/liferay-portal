<#list dataFactory.newMBCategoryModels(groupId) as mbCategoryModel>
	...
	${csvFileWriter.write("mbCategory", companyModelList[1] + "," + mbCategoryModel.categoryId + "," + mbCategoryModel.name + "\n")}
	...
	<#list dataFactory.newMBThreadModels(mbCategoryModel) as mbThreadModel>
		...
		${csvFileWriter.write("mbThread", companyModelList[1] + "," + mbCategoryModel.categoryId + "," + mbThreadModel.threadId + "," + mbThreadModel.rootMessageId + "\n")}
	</#list>
</#list>