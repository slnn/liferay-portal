<#list dataFactory.newMBCategoryModels(groupId, companyModel) as mbCategoryModel>
	...
	<#list dataFactory.newMBThreadModels(mbCategoryModel, companyModel) as mbThreadModel>
		...
		${csvFileWriter.write("mbThread", mbCategoryModel.categoryId + "," + mbThreadModel.threadId + "," + mbThreadModel.rootMessageId + "," + virtualHostModel.hostname + "," + companyModel.companyId + "\n")}
	</#list>
</#list>