...
public class LocalizedEntryLocalizationModelImpl
	...
	void setLocalizedEntryLocalizationCacheModel(
		LocalizedEntryLocalizationCacheModel
			localizedEntryLocalizationCacheModel) {

		_mvccVersion = localizedEntryLocalizationCacheModel.mvccVersion;
		_localizedEntryLocalizationId =
			localizedEntryLocalizationCacheModel.localizedEntryLocalizationId;
		_localizedEntryId =
			localizedEntryLocalizationCacheModel.localizedEntryId;

		if (localizedEntryLocalizationCacheModel.languageId == null) {
			_languageId = "";
		}
		else {
			_languageId = localizedEntryLocalizationCacheModel.languageId;
		}

		if (localizedEntryLocalizationCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = localizedEntryLocalizationCacheModel.title;
		}

		if (localizedEntryLocalizationCacheModel.content == null) {
			_content = "";
		}
		else {
			_content = localizedEntryLocalizationCacheModel.content;
		}
	}
