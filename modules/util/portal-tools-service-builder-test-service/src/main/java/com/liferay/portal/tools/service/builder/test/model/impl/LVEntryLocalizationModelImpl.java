...
public class LVEntryLocalizationModelImpl
	...
	void setLVEntryLocalizationCacheModel(
		LVEntryLocalizationCacheModel lvEntryLocalizationCacheModel) {

		_mvccVersion = lvEntryLocalizationCacheModel.mvccVersion;
		_headId = lvEntryLocalizationCacheModel.headId;
		_head = lvEntryLocalizationCacheModel.head;
		_lvEntryLocalizationId =
			lvEntryLocalizationCacheModel.lvEntryLocalizationId;
		_companyId = lvEntryLocalizationCacheModel.companyId;
		_lvEntryId = lvEntryLocalizationCacheModel.lvEntryId;

		if (lvEntryLocalizationCacheModel.languageId == null) {
			_languageId = "";
		}
		else {
			_languageId = lvEntryLocalizationCacheModel.languageId;
		}

		if (lvEntryLocalizationCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = lvEntryLocalizationCacheModel.title;
		}

		if (lvEntryLocalizationCacheModel.content == null) {
			_content = "";
		}
		else {
			_content = lvEntryLocalizationCacheModel.content;
		}
	}
