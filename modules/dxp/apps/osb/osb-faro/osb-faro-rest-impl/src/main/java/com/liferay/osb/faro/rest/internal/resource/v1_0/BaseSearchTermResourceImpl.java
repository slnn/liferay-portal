...
public abstract class BaseSearchTermResourceImpl implements SearchTermResource {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "SearchTerm")}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/workspace/{groupId}/channels/{channelId}/search-terms"
	)
