...
public class SearchTerm implements Serializable {
	...
	public static SearchTerm toDTO(String json) {
		return ObjectMapperUtil.readValue(SearchTerm.class, json);
	}

	public static SearchTerm unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SearchTerm.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Number of times the term has been searched."
	)
	...
	@GraphQLField(description = "Number of times the term has been searched.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Value of the term that was searched."
	)
	...
	@GraphQLField(description = "Value of the term that was searched.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.osb.faro.rest.dto.v1_0.SearchTerm",
		name = "x-class-name"
	)
