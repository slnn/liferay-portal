...
public interface SearchTermResource {
	...
	public static class Builder {
		...
		public SearchTermResource build() {
			return new SearchTermResourceImpl(this);
		}
	...
	public static class SearchTermResourceImpl implements SearchTermResource {
		...
		public Page<SearchTerm> getWorkspaceGroupChannelSearchTermsPage(
			...
			try {
				return Page.of(content, SearchTermSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/workspace/{groupId}/channels/{channelId}/search-terms");
		...
		private SearchTermResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SearchTermResource.class.getName());
