...
public class AttachmentModelImpl
	...
	void setAttachmentCacheModel(AttachmentCacheModel attachmentCacheModel) {
		_attachmentId = attachmentCacheModel.attachmentId;
		_companyId = attachmentCacheModel.companyId;
		_userId = attachmentCacheModel.userId;
		_accountId = attachmentCacheModel.accountId;
		_folderId = attachmentCacheModel.folderId;
		_messageId = attachmentCacheModel.messageId;

		if (attachmentCacheModel.contentPath == null) {
			_contentPath = "";
		}
		else {
			_contentPath = attachmentCacheModel.contentPath;
		}

		if (attachmentCacheModel.fileName == null) {
			_fileName = "";
		}
		else {
			_fileName = attachmentCacheModel.fileName;
		}

		_size = attachmentCacheModel.size;
	}
