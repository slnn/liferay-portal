 ...
 */
@Provider
public class ObjectEntryGroupIdExceptionMapper
	extends BaseExceptionMapper<ObjectEntryGroupIdException> {

	public ObjectEntryGroupIdExceptionMapper(Language language) {
		_language = language;
	}

	@Override
	protected Problem getProblem(
		ObjectEntryGroupIdException objectEntryGroupIdException) {
