...
public class MBThreadPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByG_NotC_L_S;
	private FinderPath _finderPathWithPaginationCountByG_NotC_L_S;
	 ...
	 */
	@Override
	public List<MBThread> findByG_NotC_L_S(
		long groupId, long categoryId, Date lastPostDate, int status) {

		return findByG_NotC_L_S(
			groupId, categoryId, lastPostDate, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<MBThread> findByG_NotC_L_S(
		...
		return findByG_NotC_L_S(
			groupId, categoryId, lastPostDate, status, start, end, null);
	}
	...
	public List<MBThread> findByG_NotC_L_S(
		...
		finderPath = _finderPathWithPaginationFindByG_NotC_L_S;
		finderArgs = new Object[] {
			groupId, categoryId, _getTime(lastPostDate), status, start, end,
			orderByComparator
		};
				...
				for (MBThread mbThread : list) {
					if ((groupId != mbThread.getGroupId()) ||
						...
						(lastPostDate.getTime() >=
							mbThread.getLastPostDate().getTime()) ||
						(status != mbThread.getStatus())) {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_NOTC_L_S_GROUPID_2);

			query.append(_FINDER_COLUMN_G_NOTC_L_S_CATEGORYID_2);

			boolean bindLastPostDate = false;

			if (lastPostDate == null) {
				query.append(_FINDER_COLUMN_G_NOTC_L_S_LASTPOSTDATE_1);
			}
			else {
				bindLastPostDate = true;

				query.append(_FINDER_COLUMN_G_NOTC_L_S_LASTPOSTDATE_2);
			}

			query.append(_FINDER_COLUMN_G_NOTC_L_S_STATUS_2);
	 ...
	 */
	@Override
	public MBThread findByG_NotC_L_S_First(
			long groupId, long categoryId, Date lastPostDate, int status,
			OrderByComparator<MBThread> orderByComparator)
		throws NoSuchThreadException {

		MBThread mbThread = fetchByG_NotC_L_S_First(
	 ...
	 */
	@Override
	public MBThread fetchByG_NotC_L_S_First(
		long groupId, long categoryId, Date lastPostDate, int status,
		OrderByComparator<MBThread> orderByComparator) {

		List<MBThread> list = findByG_NotC_L_S(
			groupId, categoryId, lastPostDate, status, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public MBThread findByG_NotC_L_S_Last(
			long groupId, long categoryId, Date lastPostDate, int status,
			OrderByComparator<MBThread> orderByComparator)
		throws NoSuchThreadException {

		MBThread mbThread = fetchByG_NotC_L_S_Last(
			groupId, categoryId, lastPostDate, status, orderByComparator);
	 ...
	 */
	@Override
	public MBThread fetchByG_NotC_L_S_Last(
		long groupId, long categoryId, Date lastPostDate, int status,
		OrderByComparator<MBThread> orderByComparator) {

		int count = countByG_NotC_L_S(
		...
		List<MBThread> list = findByG_NotC_L_S(
			groupId, categoryId, lastPostDate, status, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public MBThread[] findByG_NotC_L_S_PrevAndNext(
			long threadId, long groupId, long categoryId, Date lastPostDate,
			int status, OrderByComparator<MBThread> orderByComparator)
		throws NoSuchThreadException {
		...
		try {
			...
			array[0] = getByG_NotC_L_S_PrevAndNext(
				session, mbThread, groupId, categoryId, lastPostDate, status,
				orderByComparator, true);

			array[1] = mbThread;

			array[2] = getByG_NotC_L_S_PrevAndNext(
				session, mbThread, groupId, categoryId, lastPostDate, status,
				orderByComparator, false);
	...
	protected MBThread getByG_NotC_L_S_PrevAndNext(
		Session session, MBThread mbThread, long groupId, long categoryId,
		Date lastPostDate, int status,
		OrderByComparator<MBThread> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<MBThread> filterFindByG_NotC_L_S(
		long groupId, long categoryId, Date lastPostDate, int status) {

		return filterFindByG_NotC_L_S(
			groupId, categoryId, lastPostDate, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public MBThread[] filterFindByG_NotC_L_S_PrevAndNext(
			long threadId, long groupId, long categoryId, Date lastPostDate,
			int status, OrderByComparator<MBThread> orderByComparator)
		throws NoSuchThreadException {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_NotC_L_S_PrevAndNext(
		...
		try {
			...
			array[0] = filterGetByG_NotC_L_S_PrevAndNext(
				session, mbThread, groupId, categoryId, lastPostDate, status,
				orderByComparator, true);

			array[1] = mbThread;

			array[2] = filterGetByG_NotC_L_S_PrevAndNext(
				session, mbThread, groupId, categoryId, lastPostDate, status,
				orderByComparator, false);
	...
	protected MBThread filterGetByG_NotC_L_S_PrevAndNext(
		Session session, MBThread mbThread, long groupId, long categoryId,
		Date lastPostDate, int status,
		OrderByComparator<MBThread> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByG_NotC_L_S(
		long groupId, long categoryId, Date lastPostDate, int status) {
	 ...
	 */
	@Override
	public int countByG_NotC_L_S(
		long groupId, long categoryId, Date lastPostDate, int status) {

		FinderPath finderPath = _finderPathWithPaginationCountByG_NotC_L_S;

		Object[] finderArgs = new Object[] {
			groupId, categoryId, _getTime(lastPostDate), status
		};
	 ...
	 */
	@Override
	public int filterCountByG_NotC_L_S(
		long groupId, long categoryId, Date lastPostDate, int status) {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_NotC_L_S(groupId, categoryId, lastPostDate, status);
		}
	...
	private static final String _FINDER_COLUMN_G_NOTC_L_S_GROUPID_2 =
		"mbThread.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_NOTC_L_S_CATEGORYID_2 =
		"mbThread.categoryId != ? AND ";

	private static final String _FINDER_COLUMN_G_NOTC_L_S_LASTPOSTDATE_1 =
		"mbThread.lastPostDate IS NULL AND ";

	private static final String _FINDER_COLUMN_G_NOTC_L_S_LASTPOSTDATE_2 =
		"mbThread.lastPostDate > ? AND ";

	private static final String _FINDER_COLUMN_G_NOTC_L_S_STATUS_2 =
		"mbThread.status = ?";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_NotC_L_S = new FinderPath(
			MBThreadModelImpl.ENTITY_CACHE_ENABLED,
			MBThreadModelImpl.FINDER_CACHE_ENABLED, MBThreadImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_NotC_L_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Date.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithPaginationCountByG_NotC_L_S = new FinderPath(
			MBThreadModelImpl.ENTITY_CACHE_ENABLED,
			MBThreadModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_NotC_L_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Date.class.getName(), Integer.class.getName()
			});
