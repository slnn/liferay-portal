...
create index IX_6A3C3742 on MBCategory (categoryId, groupId, lastPostDate, status);
...
create index IX_50858876 on MBThread (categoryId, groupId, lastPostDate, status);
