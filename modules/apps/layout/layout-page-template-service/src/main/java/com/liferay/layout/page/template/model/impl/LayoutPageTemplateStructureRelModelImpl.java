...
public class LayoutPageTemplateStructureRelModelImpl
	...
	void setLayoutPageTemplateStructureRelCacheModel(
		LayoutPageTemplateStructureRelCacheModel
			layoutPageTemplateStructureRelCacheModel) {

		if (layoutPageTemplateStructureRelCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = layoutPageTemplateStructureRelCacheModel.uuid;
		}

		_layoutPageTemplateStructureRelId =
			layoutPageTemplateStructureRelCacheModel.
				layoutPageTemplateStructureRelId;
		_groupId = layoutPageTemplateStructureRelCacheModel.groupId;
		_companyId = layoutPageTemplateStructureRelCacheModel.companyId;
		_userId = layoutPageTemplateStructureRelCacheModel.userId;

		if (layoutPageTemplateStructureRelCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = layoutPageTemplateStructureRelCacheModel.userName;
		}

		if (layoutPageTemplateStructureRelCacheModel.createDate !=
				Long.MIN_VALUE) {
		...
		if (layoutPageTemplateStructureRelCacheModel.modifiedDate !=
				Long.MIN_VALUE) {
		...
		if (layoutPageTemplateStructureRelCacheModel.data == null) {
			_data = "";
		}
		else {
			_data = layoutPageTemplateStructureRelCacheModel.data;
		}
	}
