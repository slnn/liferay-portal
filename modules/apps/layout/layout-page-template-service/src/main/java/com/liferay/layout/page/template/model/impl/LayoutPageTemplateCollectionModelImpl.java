...
public class LayoutPageTemplateCollectionModelImpl
	...
	void setLayoutPageTemplateCollectionCacheModel(
		LayoutPageTemplateCollectionCacheModel
			layoutPageTemplateCollectionCacheModel) {

		if (layoutPageTemplateCollectionCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = layoutPageTemplateCollectionCacheModel.uuid;
		}

		_layoutPageTemplateCollectionId =
			layoutPageTemplateCollectionCacheModel.
				layoutPageTemplateCollectionId;
		_groupId = layoutPageTemplateCollectionCacheModel.groupId;
		_companyId = layoutPageTemplateCollectionCacheModel.companyId;
		_userId = layoutPageTemplateCollectionCacheModel.userId;

		if (layoutPageTemplateCollectionCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = layoutPageTemplateCollectionCacheModel.userName;
		}

		if (layoutPageTemplateCollectionCacheModel.createDate !=
				Long.MIN_VALUE) {
		...
		if (layoutPageTemplateCollectionCacheModel.modifiedDate !=
				Long.MIN_VALUE) {
		...
		if (layoutPageTemplateCollectionCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = layoutPageTemplateCollectionCacheModel.name;
		}

		if (layoutPageTemplateCollectionCacheModel.description == null) {
			_description = "";
		}
		else {
			_description = layoutPageTemplateCollectionCacheModel.description;
		}

		if (layoutPageTemplateCollectionCacheModel.lastPublishDate !=
				Long.MIN_VALUE) {
