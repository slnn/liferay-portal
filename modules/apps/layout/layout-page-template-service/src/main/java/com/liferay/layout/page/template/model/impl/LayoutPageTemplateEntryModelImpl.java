...
public class LayoutPageTemplateEntryModelImpl
	...
	void setLayoutPageTemplateEntryCacheModel(
		LayoutPageTemplateEntryCacheModel layoutPageTemplateEntryCacheModel) {

		if (layoutPageTemplateEntryCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = layoutPageTemplateEntryCacheModel.uuid;
		}

		_layoutPageTemplateEntryId =
			layoutPageTemplateEntryCacheModel.layoutPageTemplateEntryId;
		_groupId = layoutPageTemplateEntryCacheModel.groupId;
		_companyId = layoutPageTemplateEntryCacheModel.companyId;
		_userId = layoutPageTemplateEntryCacheModel.userId;

		if (layoutPageTemplateEntryCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = layoutPageTemplateEntryCacheModel.userName;
		}

		if (layoutPageTemplateEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(
				layoutPageTemplateEntryCacheModel.createDate);
		}

		if (layoutPageTemplateEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
		...
		_layoutPageTemplateCollectionId =
			layoutPageTemplateEntryCacheModel.layoutPageTemplateCollectionId;
		_classNameId = layoutPageTemplateEntryCacheModel.classNameId;
		_classTypeId = layoutPageTemplateEntryCacheModel.classTypeId;

		if (layoutPageTemplateEntryCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = layoutPageTemplateEntryCacheModel.name;
		}

		_type = layoutPageTemplateEntryCacheModel.type;
		_previewFileEntryId =
			layoutPageTemplateEntryCacheModel.previewFileEntryId;
		_defaultTemplate = layoutPageTemplateEntryCacheModel.defaultTemplate;
		_layoutPrototypeId =
			layoutPageTemplateEntryCacheModel.layoutPrototypeId;
		_plid = layoutPageTemplateEntryCacheModel.plid;

		if (layoutPageTemplateEntryCacheModel.lastPublishDate !=
				Long.MIN_VALUE) {
		...
		_status = layoutPageTemplateEntryCacheModel.status;
		_statusByUserId = layoutPageTemplateEntryCacheModel.statusByUserId;

		if (layoutPageTemplateEntryCacheModel.statusByUserName == null) {
			_statusByUserName = "";
		}
		else {
			_statusByUserName =
		...
		if (layoutPageTemplateEntryCacheModel.statusDate != Long.MIN_VALUE) {
