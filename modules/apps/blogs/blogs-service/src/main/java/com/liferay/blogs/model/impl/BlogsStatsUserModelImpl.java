...
public class BlogsStatsUserModelImpl
	...
	void setBlogsStatsUserCacheModel(
		BlogsStatsUserCacheModel blogsStatsUserCacheModel) {

		_statsUserId = blogsStatsUserCacheModel.statsUserId;
		_groupId = blogsStatsUserCacheModel.groupId;
		_companyId = blogsStatsUserCacheModel.companyId;
		_userId = blogsStatsUserCacheModel.userId;
		_entryCount = blogsStatsUserCacheModel.entryCount;

		if (blogsStatsUserCacheModel.lastPostDate != Long.MIN_VALUE) {
			_lastPostDate = new Date(blogsStatsUserCacheModel.lastPostDate);
		}

		_ratingsTotalEntries = blogsStatsUserCacheModel.ratingsTotalEntries;
		_ratingsTotalScore = blogsStatsUserCacheModel.ratingsTotalScore;
		_ratingsAverageScore = blogsStatsUserCacheModel.ratingsAverageScore;
	}
