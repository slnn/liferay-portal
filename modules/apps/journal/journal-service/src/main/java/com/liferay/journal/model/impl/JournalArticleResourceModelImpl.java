...
public class JournalArticleResourceModelImpl
	...
	void setJournalArticleResourceCacheModel(
		JournalArticleResourceCacheModel journalArticleResourceCacheModel) {
		...
		if (journalArticleResourceCacheModel.uuid == null) {
			...
			_uuid = journalArticleResourceCacheModel.uuid;
		}

		_resourcePrimKey = journalArticleResourceCacheModel.resourcePrimKey;
		_groupId = journalArticleResourceCacheModel.groupId;
		_companyId = journalArticleResourceCacheModel.companyId;

		if (journalArticleResourceCacheModel.articleId == null) {
			_articleId = "";
		}
		else {
			_articleId = journalArticleResourceCacheModel.articleId;
		}
	}
