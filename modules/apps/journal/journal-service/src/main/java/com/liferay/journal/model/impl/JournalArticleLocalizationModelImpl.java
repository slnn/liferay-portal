...
public class JournalArticleLocalizationModelImpl
	...
	void setJournalArticleLocalizationCacheModel(
		JournalArticleLocalizationCacheModel
			journalArticleLocalizationCacheModel) {

		_articleLocalizationId =
			journalArticleLocalizationCacheModel.articleLocalizationId;
		_companyId = journalArticleLocalizationCacheModel.companyId;
		_articlePK = journalArticleLocalizationCacheModel.articlePK;

		if (journalArticleLocalizationCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = journalArticleLocalizationCacheModel.title;
		}

		if (journalArticleLocalizationCacheModel.description == null) {
			_description = "";
		}
		else {
			_description = journalArticleLocalizationCacheModel.description;
		}

		if (journalArticleLocalizationCacheModel.languageId == null) {
			_languageId = "";
		}
		else {
			_languageId = journalArticleLocalizationCacheModel.languageId;
		}
	}
