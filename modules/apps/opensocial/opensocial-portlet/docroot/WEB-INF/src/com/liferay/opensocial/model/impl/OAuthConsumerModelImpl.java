...
public class OAuthConsumerModelImpl
	...
	void setOAuthConsumerCacheModel(
		OAuthConsumerCacheModel oAuthConsumerCacheModel) {

		_oAuthConsumerId = oAuthConsumerCacheModel.oAuthConsumerId;
		_companyId = oAuthConsumerCacheModel.companyId;

		if (oAuthConsumerCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(oAuthConsumerCacheModel.createDate);
		}

		if (oAuthConsumerCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(oAuthConsumerCacheModel.modifiedDate);
		}

		if (oAuthConsumerCacheModel.gadgetKey == null) {
			_gadgetKey = "";
		}
		else {
			_gadgetKey = oAuthConsumerCacheModel.gadgetKey;
		}

		if (oAuthConsumerCacheModel.serviceName == null) {
			_serviceName = "";
		}
		else {
			_serviceName = oAuthConsumerCacheModel.serviceName;
		}

		if (oAuthConsumerCacheModel.consumerKey == null) {
			_consumerKey = "";
		}
		else {
			_consumerKey = oAuthConsumerCacheModel.consumerKey;
		}

		if (oAuthConsumerCacheModel.consumerSecret == null) {
			_consumerSecret = "";
		}
		else {
			_consumerSecret = oAuthConsumerCacheModel.consumerSecret;
		}

		if (oAuthConsumerCacheModel.keyType == null) {
			_keyType = "";
		}
		else {
			_keyType = oAuthConsumerCacheModel.keyType;
		}
	}
