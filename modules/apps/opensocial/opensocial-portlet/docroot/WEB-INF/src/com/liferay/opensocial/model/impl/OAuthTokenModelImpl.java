...
public class OAuthTokenModelImpl
	...
	void setOAuthTokenCacheModel(OAuthTokenCacheModel oAuthTokenCacheModel) {
		_oAuthTokenId = oAuthTokenCacheModel.oAuthTokenId;
		_companyId = oAuthTokenCacheModel.companyId;
		_userId = oAuthTokenCacheModel.userId;

		if (oAuthTokenCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = oAuthTokenCacheModel.userName;
		}

		if (oAuthTokenCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(oAuthTokenCacheModel.createDate);
		}

		if (oAuthTokenCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(oAuthTokenCacheModel.modifiedDate);
		}

		if (oAuthTokenCacheModel.gadgetKey == null) {
			_gadgetKey = "";
		}
		else {
			_gadgetKey = oAuthTokenCacheModel.gadgetKey;
		}

		if (oAuthTokenCacheModel.serviceName == null) {
			_serviceName = "";
		}
		else {
			_serviceName = oAuthTokenCacheModel.serviceName;
		}

		_moduleId = oAuthTokenCacheModel.moduleId;

		if (oAuthTokenCacheModel.accessToken == null) {
			_accessToken = "";
		}
		else {
			_accessToken = oAuthTokenCacheModel.accessToken;
		}

		if (oAuthTokenCacheModel.tokenName == null) {
			_tokenName = "";
		}
		else {
			_tokenName = oAuthTokenCacheModel.tokenName;
		}

		if (oAuthTokenCacheModel.tokenSecret == null) {
			_tokenSecret = "";
		}
		else {
			_tokenSecret = oAuthTokenCacheModel.tokenSecret;
		}

		if (oAuthTokenCacheModel.sessionHandle == null) {
			_sessionHandle = "";
		}
		else {
			_sessionHandle = oAuthTokenCacheModel.sessionHandle;
		}

		_expiration = oAuthTokenCacheModel.expiration;
	}
