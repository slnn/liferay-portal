...
public class WikiPageResourceModelImpl
	...
	void setWikiPageResourceCacheModel(
		WikiPageResourceCacheModel wikiPageResourceCacheModel) {
		...
		if (wikiPageResourceCacheModel.uuid == null) {
			...
			_uuid = wikiPageResourceCacheModel.uuid;
		}

		_resourcePrimKey = wikiPageResourceCacheModel.resourcePrimKey;
		_groupId = wikiPageResourceCacheModel.groupId;
		_companyId = wikiPageResourceCacheModel.companyId;
		_nodeId = wikiPageResourceCacheModel.nodeId;

		if (wikiPageResourceCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = wikiPageResourceCacheModel.title;
		}
	}
