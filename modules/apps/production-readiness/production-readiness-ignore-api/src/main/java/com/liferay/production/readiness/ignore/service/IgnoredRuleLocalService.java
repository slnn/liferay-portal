...
/**
 * Provides the local service interface for IgnoredRule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Lily Chi
 * @see IgnoredRuleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IgnoredRuleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.production.readiness.ignore.service.impl.IgnoredRuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ignored rule local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IgnoredRuleLocalServiceUtil} if injection and service tracking are not available.
	 */
...
// LIFERAY-SERVICE-BUILDER-HASH:-628075705