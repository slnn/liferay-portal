...
public class ProductionReadinessIgnoreLocalServiceUtil {
	...
	public static ProductionReadinessIgnore addProductionReadinessIgnore(
		...
		return getService().addProductionReadinessIgnore(
			companyId, userId, ruleKey, reason);
	}
	...
	public static List<String> getIgnoredRuleKeys(long companyId)
		throws PortalException {

		return getService().getIgnoredRuleKeys(companyId);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1800888099