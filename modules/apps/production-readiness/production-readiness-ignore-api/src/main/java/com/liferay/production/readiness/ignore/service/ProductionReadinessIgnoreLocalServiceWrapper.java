...
public class ProductionReadinessIgnoreLocalServiceWrapper
	...
	public
		...
		return _productionReadinessIgnoreLocalService.
			addProductionReadinessIgnore(companyId, userId, ruleKey, reason);
	}
	...
	@Override
	public java.util.List<String> getIgnoredRuleKeys(long companyId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _productionReadinessIgnoreLocalService.getIgnoredRuleKeys(
			companyId);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1269367699