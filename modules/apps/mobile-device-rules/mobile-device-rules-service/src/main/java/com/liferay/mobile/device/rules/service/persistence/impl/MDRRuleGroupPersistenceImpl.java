...
public class MDRRuleGroupPersistenceImpl extends BasePersistenceImpl<MDRRuleGroup>
	...
	/**
	 * Returns the m d r rule group with the primary key or throws a {@link com.liferay.portal.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the m d r rule group
	...
	public MDRRuleGroup fetchByPrimaryKey(Serializable primaryKey) {
		MDRRuleGroup mdrRuleGroup = (MDRRuleGroup)entityCache.getResult(MDRRuleGroupModelImpl.ENTITY_CACHE_ENABLED,
