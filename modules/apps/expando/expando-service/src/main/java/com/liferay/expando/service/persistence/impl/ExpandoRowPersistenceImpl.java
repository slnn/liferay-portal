...
import com.liferay.expando.exception.NoSuchRowException;
import com.liferay.expando.model.ExpandoRow;
import com.liferay.expando.model.ExpandoRowTable;
import com.liferay.expando.model.impl.ExpandoRowImpl;
import com.liferay.expando.model.impl.ExpandoRowModelImpl;
import com.liferay.expando.service.persistence.ExpandoRowPersistence;
import com.liferay.expando.service.persistence.ExpandoRowUtil;
 ...
 * @generated
 */
@Component(service = ExpandoRowPersistence.class)
public class ExpandoRowPersistenceImpl
	...
	public List<ExpandoRow> findByTableId(
		...
		if (useFinderCache && productionMode) {
			list = (List<ExpandoRow>)finderCache.getResult(
	...
	public void clearCache() {
		...
		finderCache.clearCache(ExpandoRowImpl.class);
	}
	...
	public void clearCache(ExpandoRow expandoRow) {
		entityCache.removeResult(ExpandoRowImpl.class, expandoRow);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ExpandoRowImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(_finderPathFetchByT_C, args, expandoRowModelImpl);
	}
	...
	protected ExpandoRow removeImpl(ExpandoRow expandoRow) {
		...
		try {
			...
			if ((expandoRow != null) &&
				ctPersistenceHelper.isRemove(expandoRow)) {
	...
	public ExpandoRow updateImpl(ExpandoRow expandoRow) {
		...
		try {
			...
			if (ctPersistenceHelper.isInsert(expandoRow)) {
				if (!isNew) {
					session.evict(
						ExpandoRowImpl.class, expandoRow.getPrimaryKeyObj());
				}
	...
	public Map<Serializable, ExpandoRow> fetchByPrimaryKeys(
		...
		if (ctPersistenceHelper.isProductionMode(ExpandoRow.class)) {
