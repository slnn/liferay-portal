...
import com.liferay.expando.model.ExpandoColumnModel;
...
/**
 * The base model implementation for the ExpandoColumn service. Represents a row in the &quot;Expando_ExpandoColumn&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ExpandoColumnModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Expando_ExpandoColumn";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Expando_ExpandoColumn (mvccVersion LONG default 0 not null,ctCollectionId LONG default 0 not null,columnId LONG not null,companyId LONG,modifiedDate DATE null,tableId LONG,name VARCHAR(75) null,type_ INTEGER,defaultData VARCHAR(75) null,typeSettings VARCHAR(75) null,primary key (columnId, ctCollectionId))";

	public static final String TABLE_SQL_DROP =
		"drop table Expando_ExpandoColumn";

	public static final String ORDER_BY_JPQL =
		" ORDER BY expandoColumn.name ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Expando_ExpandoColumn.name ASC";
