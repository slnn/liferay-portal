...
/**
 * The arguments resolver class for retrieving value from ExpandoValue.
 *
...
@Component(
	property = {
		"class.name=com.liferay.expando.model.impl.ExpandoValueImpl",
		"table.name=Expando_ExpandoValue"
	},
	service = ArgumentsResolver.class
)
public class ExpandoValueModelArgumentsResolver implements ArgumentsResolver {
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = expandoValueModelImpl.getColumnValue(columnName);
			}
		}
