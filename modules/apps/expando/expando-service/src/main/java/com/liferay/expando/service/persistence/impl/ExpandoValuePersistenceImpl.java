...
import com.liferay.expando.exception.NoSuchValueException;
...
import com.liferay.expando.model.impl.ExpandoValueModelImpl;
import com.liferay.expando.service.persistence.ExpandoValuePersistence;
import com.liferay.expando.service.persistence.ExpandoValueUtil;
 ...
 * @generated
 */
@Component(service = ExpandoValuePersistence.class)
public class ExpandoValuePersistenceImpl
	...
	public List<ExpandoValue> findByTableId(
		...
		if (useFinderCache && productionMode) {
			list = (List<ExpandoValue>)finderCache.getResult(
	...
	public void clearCache() {
		...
		finderCache.clearCache(ExpandoValueImpl.class);
	}
	...
	public void clearCache(ExpandoValue expandoValue) {
		entityCache.removeResult(ExpandoValueImpl.class, expandoValue);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ExpandoValueImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(_finderPathCountByC_R, args, Long.valueOf(1));
		finderCache.putResult(
		...
		finderCache.putResult(_finderPathCountByT_C_C, args, Long.valueOf(1));
		finderCache.putResult(
	...
	protected ExpandoValue removeImpl(ExpandoValue expandoValue) {
		...
		try {
			...
			if ((expandoValue != null) &&
				ctPersistenceHelper.isRemove(expandoValue)) {
	...
	public ExpandoValue updateImpl(ExpandoValue expandoValue) {
		...
		try {
			...
			if (ctPersistenceHelper.isInsert(expandoValue)) {
				if (!isNew) {
					session.evict(
	...
	public Map<Serializable, ExpandoValue> fetchByPrimaryKeys(
		...
		if (ctPersistenceHelper.isProductionMode(ExpandoValue.class)) {
