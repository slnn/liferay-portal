...
import com.liferay.expando.model.impl.ExpandoTableModelImpl;
import com.liferay.expando.service.persistence.ExpandoTablePersistence;
import com.liferay.expando.service.persistence.ExpandoTableUtil;
 ...
 * @generated
 */
@Component(service = ExpandoTablePersistence.class)
public class ExpandoTablePersistenceImpl
	...
	public List<ExpandoTable> findByC_C(
		...
		if (useFinderCache && productionMode) {
			list = (List<ExpandoTable>)finderCache.getResult(
	...
	public void clearCache() {
		...
		finderCache.clearCache(ExpandoTableImpl.class);
	}
	...
	public void clearCache(ExpandoTable expandoTable) {
		entityCache.removeResult(ExpandoTableImpl.class, expandoTable);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ExpandoTableImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(_finderPathCountByC_C_N, args, Long.valueOf(1));
		finderCache.putResult(
	...
	protected ExpandoTable removeImpl(ExpandoTable expandoTable) {
		...
		try {
			...
			if ((expandoTable != null) &&
				ctPersistenceHelper.isRemove(expandoTable)) {
	...
	public ExpandoTable updateImpl(ExpandoTable expandoTable) {
		...
		try {
			...
			if (ctPersistenceHelper.isInsert(expandoTable)) {
				if (!isNew) {
					session.evict(
	...
	public Map<Serializable, ExpandoTable> fetchByPrimaryKeys(
		...
		if (ctPersistenceHelper.isProductionMode(ExpandoTable.class)) {
