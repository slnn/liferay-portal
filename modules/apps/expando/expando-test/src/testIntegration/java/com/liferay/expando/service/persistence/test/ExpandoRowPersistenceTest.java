...
package com.liferay.expando.service.persistence.test;

import com.liferay.arquillian.extension.junit.bridge.junit.Arquillian;
import com.liferay.expando.exception.NoSuchRowException;
import com.liferay.expando.model.ExpandoRow;
import com.liferay.expando.service.ExpandoRowLocalServiceUtil;
...
public class ExpandoRowPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "com.liferay.expando.service"));
	...
	protected OrderByComparator<ExpandoRow> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"Expando_ExpandoRow", "mvccVersion", true, "ctCollectionId", true,
			"rowId", true, "companyId", true, "modifiedDate", true, "tableId",
			true, "classPK", true);
	}
