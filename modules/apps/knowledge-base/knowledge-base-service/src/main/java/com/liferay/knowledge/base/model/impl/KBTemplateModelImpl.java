...
public class KBTemplateModelImpl
	...
	void setKBTemplateCacheModel(KBTemplateCacheModel kbTemplateCacheModel) {
		if (kbTemplateCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = kbTemplateCacheModel.uuid;
		}

		_kbTemplateId = kbTemplateCacheModel.kbTemplateId;
		_groupId = kbTemplateCacheModel.groupId;
		_companyId = kbTemplateCacheModel.companyId;
		_userId = kbTemplateCacheModel.userId;

		if (kbTemplateCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = kbTemplateCacheModel.userName;
		}

		if (kbTemplateCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(kbTemplateCacheModel.createDate);
		}

		if (kbTemplateCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(kbTemplateCacheModel.modifiedDate);
		}

		if (kbTemplateCacheModel.title == null) {
			_title = "";
		}
		else {
			_title = kbTemplateCacheModel.title;
		}

		if (kbTemplateCacheModel.content == null) {
			_content = "";
		}
		else {
			_content = kbTemplateCacheModel.content;
		}

		if (kbTemplateCacheModel.lastPublishDate != Long.MIN_VALUE) {
			_lastPublishDate = new Date(kbTemplateCacheModel.lastPublishDate);
		}
	}
