...
public class LockModelImpl extends BaseModelImpl<Lock> implements LockModel {
	...
	void setLockCacheModel(LockCacheModel lockCacheModel) {
		_mvccVersion = lockCacheModel.mvccVersion;

		if (lockCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = lockCacheModel.uuid;
		}

		_lockId = lockCacheModel.lockId;
		_companyId = lockCacheModel.companyId;
		_userId = lockCacheModel.userId;

		if (lockCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = lockCacheModel.userName;
		}

		if (lockCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(lockCacheModel.createDate);
		}
		...
		if (lockCacheModel.className == null) {
			...
			_className = lockCacheModel.className;
		}

		if (lockCacheModel.key == null) {
			_key = "";
		}
		else {
			_key = lockCacheModel.key;
		}
		...
		if (lockCacheModel.owner == null) {
			...
			_owner = lockCacheModel.owner;
		}

		_inheritable = lockCacheModel.inheritable;

		if (lockCacheModel.expirationDate != Long.MIN_VALUE) {
			_expirationDate = new Date(lockCacheModel.expirationDate);
		}
	}
