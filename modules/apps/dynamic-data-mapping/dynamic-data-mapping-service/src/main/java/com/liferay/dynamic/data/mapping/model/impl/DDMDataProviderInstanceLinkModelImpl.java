...
public class DDMDataProviderInstanceLinkModelImpl
	...
	void setDDMDataProviderInstanceLinkCacheModel(
		DDMDataProviderInstanceLinkCacheModel
			ddmDataProviderInstanceLinkCacheModel) {

		_dataProviderInstanceLinkId =
			ddmDataProviderInstanceLinkCacheModel.dataProviderInstanceLinkId;
		_companyId = ddmDataProviderInstanceLinkCacheModel.companyId;
		_dataProviderInstanceId =
			ddmDataProviderInstanceLinkCacheModel.dataProviderInstanceId;
		_structureId = ddmDataProviderInstanceLinkCacheModel.structureId;
	}
