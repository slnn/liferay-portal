...
public class AMImageConfigurationHelperImpl
	...
	public Collection<AMImageConfigurationEntry> getAMImageConfigurationEntries(
		...
		List<AMImageConfigurationEntry> filteredAMImageConfigurationEntryList =
			ListUtil.filter(
				amImageConfigurationEntryList,
				AMImageConfigurationEntry::isEnabled);

		Collections.sort(
			filteredAMImageConfigurationEntryList,
			Comparator.comparing(AMImageConfigurationEntry::getName));

		return filteredAMImageConfigurationEntryList;
	}
	...
	public Collection<AMImageConfigurationEntry> getAMImageConfigurationEntries(
		...
		List<AMImageConfigurationEntry> filteredAMImageConfigurationEntryList =
			ListUtil.filter(amImageConfigurationEntryList, predicate);
	...
	public AMImageConfigurationEntry getAMImageConfigurationEntry(
		...
		if (filteredAMImageConfigurationEntryList.isEmpty()) {
			return null;
		}

		return filteredAMImageConfigurationEntryList.get(0);
	}
			...
			amImageConfigurationEntries =
				(ArrayList<AMImageConfigurationEntry>)
					TransformUtil.transformToList(
						imageVariants, _amImageConfigurationEntryParser::parse);
