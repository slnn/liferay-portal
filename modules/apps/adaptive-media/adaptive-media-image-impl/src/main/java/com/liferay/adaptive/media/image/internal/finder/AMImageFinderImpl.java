...
public class AMImageFinderImpl implements AMImageFinder {
	...
	@Override
	public List<AdaptiveMedia<AMImageProcessor>> getAdaptiveMediaList(
			Function
		...
		Collections.sort(
			adaptiveMediaList, amDistanceComparator.toComparator());

		return adaptiveMediaList;
	}
