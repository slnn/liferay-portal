...
public class SubscriptionPersistenceImpl
	...
	/**
	 * Returns all the subscriptions where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Subscription> findByC_U_C(
		long companyId, long userId, long classNameId) {

		return findByC_U_C(
			companyId, userId, classNameId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the subscriptions where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>SubscriptionModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<Subscription> findByC_U_C(
		long companyId, long userId, long classNameId, int start, int end) {

		return findByC_U_C(companyId, userId, classNameId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the subscriptions where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>SubscriptionModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Subscription> findByC_U_C(
		...
		return findByC_U_C(
			companyId, userId, classNameId, start, end, orderByComparator,
			true);
	}
	...
	public List<Subscription> findByC_U_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] {companyId, userId, classNameId};
		}
		else {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_U_C_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_U_C_USERID_2);

			query.append(_FINDER_COLUMN_C_U_C_CLASSNAMEID_2);
	...
	/**
	 * Returns the first subscription in the ordered set where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public Subscription findByC_U_C_First(
			long companyId, long userId, long classNameId,
			OrderByComparator<Subscription> orderByComparator)
		throws NoSuchSubscriptionException {

		Subscription subscription = fetchByC_U_C_First(
			companyId, userId, classNameId, orderByComparator);
	 ...
	 */
	@Override
	public Subscription fetchByC_U_C_First(
		long companyId, long userId, long classNameId,
		OrderByComparator<Subscription> orderByComparator) {

		List<Subscription> list = findByC_U_C(
			companyId, userId, classNameId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last subscription in the ordered set where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public Subscription findByC_U_C_Last(
			long companyId, long userId, long classNameId,
			OrderByComparator<Subscription> orderByComparator)
		throws NoSuchSubscriptionException {

		Subscription subscription = fetchByC_U_C_Last(
			companyId, userId, classNameId, orderByComparator);
	 ...
	 */
	@Override
	public Subscription fetchByC_U_C_Last(
		long companyId, long userId, long classNameId,
		OrderByComparator<Subscription> orderByComparator) {

		int count = countByC_U_C(companyId, userId, classNameId);
		...
		List<Subscription> list = findByC_U_C(
			companyId, userId, classNameId, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the subscriptions before and after the current subscription in the ordered set where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * @param subscriptionId the primary key of the current subscription
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public Subscription[] findByC_U_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_U_C_PrevAndNext(
				session, subscription, companyId, userId, classNameId,
	...
	protected Subscription getByC_U_C_PrevAndNext(
		Session session, Subscription subscription, long companyId, long userId,
		long classNameId, OrderByComparator<Subscription> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the subscriptions where companyId = &#63; and userId = &#63; and classNameId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	/**
	 * Returns the number of subscriptions where companyId = &#63; and userId = &#63; and classNameId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	public int countByC_U_C(long companyId, long userId, long classNameId) {
		...
		Object[] finderArgs = new Object[] {companyId, userId, classNameId};
	...
	private static final String _FINDER_COLUMN_C_U_C_CLASSNAMEID_2 =
		"subscription.classNameId = ?";
	...
	public Subscription updateImpl(Subscription subscription) {
		...
		if (!SubscriptionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			finderCache.removeResult(_finderPathCountByC_U_C, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByC_U_C, args);
			...
			if ((subscriptionModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByC_U_C.getColumnBitmask()) !=
					 0) {
