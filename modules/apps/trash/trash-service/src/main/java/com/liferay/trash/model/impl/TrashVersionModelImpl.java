...
public class TrashVersionModelImpl
	...
	void setTrashVersionCacheModel(
		TrashVersionCacheModel trashVersionCacheModel) {

		_versionId = trashVersionCacheModel.versionId;
		_companyId = trashVersionCacheModel.companyId;
		_entryId = trashVersionCacheModel.entryId;
		_classNameId = trashVersionCacheModel.classNameId;
		_classPK = trashVersionCacheModel.classPK;

		if (trashVersionCacheModel.typeSettings == null) {
			_typeSettings = "";
		}
		else {
			_typeSettings = trashVersionCacheModel.typeSettings;
		}

		_status = trashVersionCacheModel.status;
	}
