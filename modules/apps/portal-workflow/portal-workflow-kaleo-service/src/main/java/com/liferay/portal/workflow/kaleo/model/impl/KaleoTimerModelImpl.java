...
public class KaleoTimerModelImpl
	...
	void setKaleoTimerCacheModel(KaleoTimerCacheModel kaleoTimerCacheModel) {
		_mvccVersion = kaleoTimerCacheModel.mvccVersion;
		_kaleoTimerId = kaleoTimerCacheModel.kaleoTimerId;
		_groupId = kaleoTimerCacheModel.groupId;
		_companyId = kaleoTimerCacheModel.companyId;
		_userId = kaleoTimerCacheModel.userId;

		if (kaleoTimerCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = kaleoTimerCacheModel.userName;
		}

		if (kaleoTimerCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(kaleoTimerCacheModel.createDate);
		}

		if (kaleoTimerCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(kaleoTimerCacheModel.modifiedDate);
		}

		if (kaleoTimerCacheModel.kaleoClassName == null) {
			_kaleoClassName = "";
		}
		else {
			_kaleoClassName = kaleoTimerCacheModel.kaleoClassName;
		}

		_kaleoClassPK = kaleoTimerCacheModel.kaleoClassPK;
		_kaleoDefinitionVersionId =
			kaleoTimerCacheModel.kaleoDefinitionVersionId;

		if (kaleoTimerCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = kaleoTimerCacheModel.name;
		}

		_blocking = kaleoTimerCacheModel.blocking;

		if (kaleoTimerCacheModel.description == null) {
			_description = "";
		}
		else {
			_description = kaleoTimerCacheModel.description;
		}

		_duration = kaleoTimerCacheModel.duration;

		if (kaleoTimerCacheModel.scale == null) {
			_scale = "";
		}
		else {
			_scale = kaleoTimerCacheModel.scale;
		}

		_recurrenceDuration = kaleoTimerCacheModel.recurrenceDuration;

		if (kaleoTimerCacheModel.recurrenceScale == null) {
			_recurrenceScale = "";
		}
		else {
			_recurrenceScale = kaleoTimerCacheModel.recurrenceScale;
		}
	}
