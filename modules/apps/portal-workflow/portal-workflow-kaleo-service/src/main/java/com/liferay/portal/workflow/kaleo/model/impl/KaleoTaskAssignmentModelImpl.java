...
public class KaleoTaskAssignmentModelImpl
	...
	public void setKaleoTaskAssignmentId(long kaleoTaskAssignmentId) {
		if (_kaleoTaskAssignmentOriginalValues == null) {
			_kaleoTaskAssignmentOriginalValues =
				new KaleoTaskAssignmentOriginalValues(this);
		}

		_kaleoTaskAssignmentOriginalValues._columnBitmask = -1L;
	...
	public void setCompanyId(long companyId) {
		...
		_kaleoTaskAssignmentOriginalValues._columnBitmask |=
	...
	public long getOriginalCompanyId() {
		...
		return _kaleoTaskAssignmentOriginalValues._originalCompanyId;
	}
	...
	public String getOriginalKaleoClassName() {
		...
		return GetterUtil.getString(
			_kaleoTaskAssignmentOriginalValues._originalKaleoClassName);
	}
	...
	public long getOriginalKaleoClassPK() {
		...
		return _kaleoTaskAssignmentOriginalValues._originalKaleoClassPK;
	}
	...
	public long getOriginalKaleoDefinitionVersionId() {
		...
		return _kaleoTaskAssignmentOriginalValues.
	...
	public String getOriginalAssigneeClassName() {
		...
		return GetterUtil.getString(
			_kaleoTaskAssignmentOriginalValues._originalAssigneeClassName);
	}
	...
	public long getColumnBitmask() {
		...
		return _kaleoTaskAssignmentOriginalValues._columnBitmask;
	}
	...
	public void resetOriginalValues() {
		...
		kaleoTaskAssignmentModelImpl._kaleoTaskAssignmentOriginalValues = null;
	...
	void setKaleoTaskAssignmentCacheModel(
		KaleoTaskAssignmentCacheModel kaleoTaskAssignmentCacheModel) {

		_mvccVersion = kaleoTaskAssignmentCacheModel.mvccVersion;
		_kaleoTaskAssignmentId =
			kaleoTaskAssignmentCacheModel.kaleoTaskAssignmentId;
		_groupId = kaleoTaskAssignmentCacheModel.groupId;
		_companyId = kaleoTaskAssignmentCacheModel.companyId;
		_userId = kaleoTaskAssignmentCacheModel.userId;

		if (kaleoTaskAssignmentCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = kaleoTaskAssignmentCacheModel.userName;
		}

		if (kaleoTaskAssignmentCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(kaleoTaskAssignmentCacheModel.createDate);
		}

		if (kaleoTaskAssignmentCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(
				kaleoTaskAssignmentCacheModel.modifiedDate);
		}

		if (kaleoTaskAssignmentCacheModel.kaleoClassName == null) {
			_kaleoClassName = "";
		}
		else {
			_kaleoClassName = kaleoTaskAssignmentCacheModel.kaleoClassName;
		}

		_kaleoClassPK = kaleoTaskAssignmentCacheModel.kaleoClassPK;
		_kaleoDefinitionVersionId =
			kaleoTaskAssignmentCacheModel.kaleoDefinitionVersionId;
		_kaleoNodeId = kaleoTaskAssignmentCacheModel.kaleoNodeId;

		if (kaleoTaskAssignmentCacheModel.assigneeClassName == null) {
			_assigneeClassName = "";
		}
		else {
			_assigneeClassName =
		...
		_assigneeClassPK = kaleoTaskAssignmentCacheModel.assigneeClassPK;

		if (kaleoTaskAssignmentCacheModel.assigneeActionId == null) {
			_assigneeActionId = "";
		}
		else {
			_assigneeActionId = kaleoTaskAssignmentCacheModel.assigneeActionId;
		}

		if (kaleoTaskAssignmentCacheModel.assigneeScript == null) {
			_assigneeScript = "";
		}
		else {
			_assigneeScript = kaleoTaskAssignmentCacheModel.assigneeScript;
		}

		if (kaleoTaskAssignmentCacheModel.assigneeScriptLanguage == null) {
			_assigneeScriptLanguage = "";
		}
		else {
			_assigneeScriptLanguage =
				kaleoTaskAssignmentCacheModel.assigneeScriptLanguage;
		...
		if (kaleoTaskAssignmentCacheModel.assigneeScriptRequiredContexts ==
				null) {

			_assigneeScriptRequiredContexts = "";
		}
		else {
			_assigneeScriptRequiredContexts =
				kaleoTaskAssignmentCacheModel.assigneeScriptRequiredContexts;
	...
	private static class KaleoTaskAssignmentOriginalValues {

		private KaleoTaskAssignmentOriginalValues(
			KaleoTaskAssignmentModelImpl kaleoTaskAssignmentModelImpl) {

			_originalCompanyId = kaleoTaskAssignmentModelImpl._companyId;
			_originalKaleoClassName =
				kaleoTaskAssignmentModelImpl._kaleoClassName;
			_originalKaleoClassPK = kaleoTaskAssignmentModelImpl._kaleoClassPK;
			_originalKaleoDefinitionVersionId =
		...
		private final String _originalAssigneeClassName;
