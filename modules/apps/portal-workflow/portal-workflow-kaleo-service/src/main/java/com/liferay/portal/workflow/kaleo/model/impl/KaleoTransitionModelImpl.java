...
public class KaleoTransitionModelImpl
	...
	void setKaleoTransitionCacheModel(
		KaleoTransitionCacheModel kaleoTransitionCacheModel) {

		_mvccVersion = kaleoTransitionCacheModel.mvccVersion;
		_kaleoTransitionId = kaleoTransitionCacheModel.kaleoTransitionId;
		_groupId = kaleoTransitionCacheModel.groupId;
		_companyId = kaleoTransitionCacheModel.companyId;
		_userId = kaleoTransitionCacheModel.userId;

		if (kaleoTransitionCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = kaleoTransitionCacheModel.userName;
		}

		if (kaleoTransitionCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(kaleoTransitionCacheModel.createDate);
		}

		if (kaleoTransitionCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(kaleoTransitionCacheModel.modifiedDate);
		}

		_kaleoDefinitionVersionId =
			kaleoTransitionCacheModel.kaleoDefinitionVersionId;
		_kaleoNodeId = kaleoTransitionCacheModel.kaleoNodeId;

		if (kaleoTransitionCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = kaleoTransitionCacheModel.name;
		}

		if (kaleoTransitionCacheModel.description == null) {
			_description = "";
		}
		else {
			_description = kaleoTransitionCacheModel.description;
		}

		_sourceKaleoNodeId = kaleoTransitionCacheModel.sourceKaleoNodeId;

		if (kaleoTransitionCacheModel.sourceKaleoNodeName == null) {
			_sourceKaleoNodeName = "";
		}
		else {
			_sourceKaleoNodeName =
				kaleoTransitionCacheModel.sourceKaleoNodeName;
		...
		_targetKaleoNodeId = kaleoTransitionCacheModel.targetKaleoNodeId;

		if (kaleoTransitionCacheModel.targetKaleoNodeName == null) {
			_targetKaleoNodeName = "";
		}
		else {
			_targetKaleoNodeName =
				kaleoTransitionCacheModel.targetKaleoNodeName;
		...
		_defaultTransition = kaleoTransitionCacheModel.defaultTransition;
	}
