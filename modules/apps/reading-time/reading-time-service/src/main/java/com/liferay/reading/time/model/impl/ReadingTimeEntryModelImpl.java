...
public class ReadingTimeEntryModelImpl
	...
	void setReadingTimeEntryCacheModel(
		ReadingTimeEntryCacheModel readingTimeEntryCacheModel) {

		if (readingTimeEntryCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = readingTimeEntryCacheModel.uuid;
		}

		_readingTimeEntryId = readingTimeEntryCacheModel.readingTimeEntryId;
		_groupId = readingTimeEntryCacheModel.groupId;
		_companyId = readingTimeEntryCacheModel.companyId;

		if (readingTimeEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(readingTimeEntryCacheModel.createDate);
		}

		if (readingTimeEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(readingTimeEntryCacheModel.modifiedDate);
		}

		_classNameId = readingTimeEntryCacheModel.classNameId;
		_classPK = readingTimeEntryCacheModel.classPK;
		_readingTime = readingTimeEntryCacheModel.readingTime;
	}
