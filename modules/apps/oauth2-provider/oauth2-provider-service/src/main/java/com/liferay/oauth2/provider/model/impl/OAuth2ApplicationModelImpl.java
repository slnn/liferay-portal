...
public class OAuth2ApplicationModelImpl
	...
	void setOAuth2ApplicationCacheModel(
		OAuth2ApplicationCacheModel oAuth2ApplicationCacheModel) {

		_oAuth2ApplicationId = oAuth2ApplicationCacheModel.oAuth2ApplicationId;
		_companyId = oAuth2ApplicationCacheModel.companyId;
		_userId = oAuth2ApplicationCacheModel.userId;

		if (oAuth2ApplicationCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = oAuth2ApplicationCacheModel.userName;
		}

		if (oAuth2ApplicationCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(oAuth2ApplicationCacheModel.createDate);
		}

		if (oAuth2ApplicationCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(oAuth2ApplicationCacheModel.modifiedDate);
		}

		_oAuth2ApplicationScopeAliasesId =
			oAuth2ApplicationCacheModel.oAuth2ApplicationScopeAliasesId;

		if (oAuth2ApplicationCacheModel.allowedGrantTypes == null) {
			_allowedGrantTypes = "";
		}
		else {
			_allowedGrantTypes = oAuth2ApplicationCacheModel.allowedGrantTypes;
		}

		_clientCredentialUserId =
			oAuth2ApplicationCacheModel.clientCredentialUserId;

		if (oAuth2ApplicationCacheModel.clientCredentialUserName == null) {
		...
		if (oAuth2ApplicationCacheModel.clientId == null) {
			_clientId = "";
		}
		else {
			_clientId = oAuth2ApplicationCacheModel.clientId;
		}

		_clientProfile = oAuth2ApplicationCacheModel.clientProfile;

		if (oAuth2ApplicationCacheModel.clientSecret == null) {
			_clientSecret = "";
		}
		else {
			_clientSecret = oAuth2ApplicationCacheModel.clientSecret;
		}

		if (oAuth2ApplicationCacheModel.description == null) {
			_description = "";
		}
		else {
			_description = oAuth2ApplicationCacheModel.description;
		}

		if (oAuth2ApplicationCacheModel.features == null) {
			_features = "";
		}
		else {
			_features = oAuth2ApplicationCacheModel.features;
		}

		if (oAuth2ApplicationCacheModel.homePageURL == null) {
			_homePageURL = "";
		}
		else {
			_homePageURL = oAuth2ApplicationCacheModel.homePageURL;
		}

		_iconFileEntryId = oAuth2ApplicationCacheModel.iconFileEntryId;

		if (oAuth2ApplicationCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = oAuth2ApplicationCacheModel.name;
		}

		if (oAuth2ApplicationCacheModel.privacyPolicyURL == null) {
			_privacyPolicyURL = "";
		}
		else {
			_privacyPolicyURL = oAuth2ApplicationCacheModel.privacyPolicyURL;
		}

		if (oAuth2ApplicationCacheModel.redirectURIs == null) {
			_redirectURIs = "";
		}
		else {
			_redirectURIs = oAuth2ApplicationCacheModel.redirectURIs;
		}
	}
