...
public class OAuth2ApplicationScopeAliasesModelImpl
	...
	void setOAuth2ApplicationScopeAliasesCacheModel(
		OAuth2ApplicationScopeAliasesCacheModel
			oAuth2ApplicationScopeAliasesCacheModel) {
		...
		_oAuth2ApplicationScopeAliasesId =
			oAuth2ApplicationScopeAliasesCacheModel.
				oAuth2ApplicationScopeAliasesId;
		_companyId = oAuth2ApplicationScopeAliasesCacheModel.companyId;
		_userId = oAuth2ApplicationScopeAliasesCacheModel.userId;

		if (oAuth2ApplicationScopeAliasesCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = oAuth2ApplicationScopeAliasesCacheModel.userName;
		}

		if (oAuth2ApplicationScopeAliasesCacheModel.createDate !=
				Long.MIN_VALUE) {
