...
public class OAuth2AuthorizationModelImpl
	...
	void setOAuth2AuthorizationCacheModel(
		OAuth2AuthorizationCacheModel oAuth2AuthorizationCacheModel) {

		_oAuth2AuthorizationId =
			oAuth2AuthorizationCacheModel.oAuth2AuthorizationId;
		_companyId = oAuth2AuthorizationCacheModel.companyId;
		_userId = oAuth2AuthorizationCacheModel.userId;

		if (oAuth2AuthorizationCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = oAuth2AuthorizationCacheModel.userName;
		}

		if (oAuth2AuthorizationCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(oAuth2AuthorizationCacheModel.createDate);
		}
		...
		if (oAuth2AuthorizationCacheModel.accessTokenContent == null) {
			_accessTokenContent = "";
		}
		else {
			_accessTokenContent =
		...
		_accessTokenContentHash =
			oAuth2AuthorizationCacheModel.accessTokenContentHash;

		if (oAuth2AuthorizationCacheModel.accessTokenCreateDate !=
				Long.MIN_VALUE) {

			_accessTokenCreateDate = new Date(
				oAuth2AuthorizationCacheModel.accessTokenCreateDate);
		}

		if (oAuth2AuthorizationCacheModel.accessTokenExpirationDate !=
				Long.MIN_VALUE) {

			_accessTokenExpirationDate = new Date(
				oAuth2AuthorizationCacheModel.accessTokenExpirationDate);
		}

		if (oAuth2AuthorizationCacheModel.remoteHostInfo == null) {
			_remoteHostInfo = "";
		}
		else {
			_remoteHostInfo = oAuth2AuthorizationCacheModel.remoteHostInfo;
		}

		if (oAuth2AuthorizationCacheModel.remoteIPInfo == null) {
			_remoteIPInfo = "";
		}
		else {
			_remoteIPInfo = oAuth2AuthorizationCacheModel.remoteIPInfo;
		}

		if (oAuth2AuthorizationCacheModel.refreshTokenContent == null) {
			_refreshTokenContent = "";
		}
		else {
			_refreshTokenContent =
				oAuth2AuthorizationCacheModel.refreshTokenContent;
		...
		_refreshTokenContentHash =
			oAuth2AuthorizationCacheModel.refreshTokenContentHash;

		if (oAuth2AuthorizationCacheModel.refreshTokenCreateDate !=
				Long.MIN_VALUE) {

			_refreshTokenCreateDate = new Date(
				oAuth2AuthorizationCacheModel.refreshTokenCreateDate);
		}

		if (oAuth2AuthorizationCacheModel.refreshTokenExpirationDate !=
				Long.MIN_VALUE) {

			_refreshTokenExpirationDate = new Date(
				oAuth2AuthorizationCacheModel.refreshTokenExpirationDate);
		}
	}
