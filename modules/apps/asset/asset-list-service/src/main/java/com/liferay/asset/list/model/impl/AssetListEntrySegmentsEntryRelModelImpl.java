...
public class AssetListEntrySegmentsEntryRelModelImpl
	...
	void setAssetListEntrySegmentsEntryRelCacheModel(
		AssetListEntrySegmentsEntryRelCacheModel
			assetListEntrySegmentsEntryRelCacheModel) {

		if (assetListEntrySegmentsEntryRelCacheModel.uuid == null) {
			_uuid = "";
		}
		else {
			_uuid = assetListEntrySegmentsEntryRelCacheModel.uuid;
		}

		_assetListEntrySegmentsEntryRelId =
			assetListEntrySegmentsEntryRelCacheModel.
				assetListEntrySegmentsEntryRelId;
		_groupId = assetListEntrySegmentsEntryRelCacheModel.groupId;
		_companyId = assetListEntrySegmentsEntryRelCacheModel.companyId;
		_userId = assetListEntrySegmentsEntryRelCacheModel.userId;

		if (assetListEntrySegmentsEntryRelCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = assetListEntrySegmentsEntryRelCacheModel.userName;
		}

		if (assetListEntrySegmentsEntryRelCacheModel.createDate !=
				Long.MIN_VALUE) {
		...
		if (assetListEntrySegmentsEntryRelCacheModel.modifiedDate !=
				Long.MIN_VALUE) {
		...
		if (assetListEntrySegmentsEntryRelCacheModel.typeSettings == null) {
			_typeSettings = "";
		}
		else {
			_typeSettings =
		...
		if (assetListEntrySegmentsEntryRelCacheModel.lastPublishDate !=
				Long.MIN_VALUE) {
