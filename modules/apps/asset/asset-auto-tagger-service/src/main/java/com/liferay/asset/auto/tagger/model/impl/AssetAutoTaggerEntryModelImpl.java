...
public class AssetAutoTaggerEntryModelImpl
	...
	void setAssetAutoTaggerEntryCacheModel(
		AssetAutoTaggerEntryCacheModel assetAutoTaggerEntryCacheModel) {

		_assetAutoTaggerEntryId =
			assetAutoTaggerEntryCacheModel.assetAutoTaggerEntryId;
		_groupId = assetAutoTaggerEntryCacheModel.groupId;
		_companyId = assetAutoTaggerEntryCacheModel.companyId;

		if (assetAutoTaggerEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(assetAutoTaggerEntryCacheModel.createDate);
		}

		if (assetAutoTaggerEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(
				assetAutoTaggerEntryCacheModel.modifiedDate);
		}

		_assetEntryId = assetAutoTaggerEntryCacheModel.assetEntryId;
		_assetTagId = assetAutoTaggerEntryCacheModel.assetTagId;
	}
