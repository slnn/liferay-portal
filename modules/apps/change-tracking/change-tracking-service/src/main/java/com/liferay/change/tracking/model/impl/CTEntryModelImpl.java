...
public class CTEntryModelImpl
	...
	void setCTEntryCacheModel(CTEntryCacheModel ctEntryCacheModel) {
		_ctEntryId = ctEntryCacheModel.ctEntryId;
		_companyId = ctEntryCacheModel.companyId;
		_userId = ctEntryCacheModel.userId;

		if (ctEntryCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = ctEntryCacheModel.userName;
		}

		if (ctEntryCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(ctEntryCacheModel.createDate);
		}

		if (ctEntryCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(ctEntryCacheModel.modifiedDate);
		}

		_originalCTCollectionId = ctEntryCacheModel.originalCTCollectionId;
		_modelClassNameId = ctEntryCacheModel.modelClassNameId;
		_modelClassPK = ctEntryCacheModel.modelClassPK;
		_modelResourcePrimKey = ctEntryCacheModel.modelResourcePrimKey;
		_changeType = ctEntryCacheModel.changeType;
		_collision = ctEntryCacheModel.collision;
		_status = ctEntryCacheModel.status;
	}
