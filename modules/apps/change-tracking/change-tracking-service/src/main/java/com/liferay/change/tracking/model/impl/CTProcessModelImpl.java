...
public class CTProcessModelImpl
	...
	void setCTProcessCacheModel(CTProcessCacheModel ctProcessCacheModel) {
		_ctProcessId = ctProcessCacheModel.ctProcessId;
		_companyId = ctProcessCacheModel.companyId;
		_userId = ctProcessCacheModel.userId;

		if (ctProcessCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(ctProcessCacheModel.createDate);
		}

		_ctCollectionId = ctProcessCacheModel.ctCollectionId;
		_backgroundTaskId = ctProcessCacheModel.backgroundTaskId;
	}
