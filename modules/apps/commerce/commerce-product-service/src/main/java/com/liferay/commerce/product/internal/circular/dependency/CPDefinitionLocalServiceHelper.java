...
package com.liferay.commerce.product.internal.circular.dependency;
 ...
 * @author Lily Chi
 */
@Component(service = CPDefinitionLocalServiceHelper.class)
public class CPDefinitionLocalServiceHelper {
	...
	private static volatile CPDefinitionLocalService _cpDefinitionLocalService =
		ServiceProxyFactory.newServiceTrackedInstance(
			...
			CPDefinitionLocalServiceHelper.class, "_cpDefinitionLocalService",
