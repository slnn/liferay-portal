...
public class DLContentModelImpl
	...
	void setDLContentCacheModel(DLContentCacheModel dlContentCacheModel) {
		_contentId = dlContentCacheModel.contentId;
		_groupId = dlContentCacheModel.groupId;
		_companyId = dlContentCacheModel.companyId;
		_repositoryId = dlContentCacheModel.repositoryId;

		if (dlContentCacheModel.path == null) {
			_path = "";
		}
		else {
			_path = dlContentCacheModel.path;
		}
		...
		if (dlContentCacheModel.version == null) {
			...
			_version = dlContentCacheModel.version;
		}

		_size = dlContentCacheModel.size;
	}
