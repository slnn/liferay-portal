...
public class PowwowParticipantModelImpl
	...
	void setPowwowParticipantCacheModel(
		PowwowParticipantCacheModel powwowParticipantCacheModel) {

		_powwowParticipantId = powwowParticipantCacheModel.powwowParticipantId;
		_groupId = powwowParticipantCacheModel.groupId;
		_companyId = powwowParticipantCacheModel.companyId;
		_userId = powwowParticipantCacheModel.userId;

		if (powwowParticipantCacheModel.userName == null) {
			_userName = "";
		}
		else {
			_userName = powwowParticipantCacheModel.userName;
		}

		if (powwowParticipantCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(powwowParticipantCacheModel.createDate);
		}

		if (powwowParticipantCacheModel.modifiedDate != Long.MIN_VALUE) {
			_modifiedDate = new Date(powwowParticipantCacheModel.modifiedDate);
		}

		_powwowMeetingId = powwowParticipantCacheModel.powwowMeetingId;

		if (powwowParticipantCacheModel.name == null) {
			_name = "";
		}
		else {
			_name = powwowParticipantCacheModel.name;
		}

		_participantUserId = powwowParticipantCacheModel.participantUserId;

		if (powwowParticipantCacheModel.emailAddress == null) {
			_emailAddress = "";
		}
		else {
			_emailAddress = powwowParticipantCacheModel.emailAddress;
		}

		_type = powwowParticipantCacheModel.type;
		_status = powwowParticipantCacheModel.status;
	}
