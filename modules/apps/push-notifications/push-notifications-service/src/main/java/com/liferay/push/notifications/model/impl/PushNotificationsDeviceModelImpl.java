...
public class PushNotificationsDeviceModelImpl
	...
	void setPushNotificationsDeviceCacheModel(
		PushNotificationsDeviceCacheModel pushNotificationsDeviceCacheModel) {

		_pushNotificationsDeviceId =
			pushNotificationsDeviceCacheModel.pushNotificationsDeviceId;
		_companyId = pushNotificationsDeviceCacheModel.companyId;
		_userId = pushNotificationsDeviceCacheModel.userId;

		if (pushNotificationsDeviceCacheModel.createDate != Long.MIN_VALUE) {
			_createDate = new Date(
				pushNotificationsDeviceCacheModel.createDate);
		}

		if (pushNotificationsDeviceCacheModel.platform == null) {
			_platform = "";
		}
		else {
			_platform = pushNotificationsDeviceCacheModel.platform;
		}

		if (pushNotificationsDeviceCacheModel.token == null) {
			_token = "";
		}
		else {
			_token = pushNotificationsDeviceCacheModel.token;
		}
	}
