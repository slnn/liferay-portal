...
public class StatusModelImpl
	...
	void setStatusCacheModel(StatusCacheModel statusCacheModel) {
		_statusId = statusCacheModel.statusId;
		_userId = statusCacheModel.userId;
		_modifiedDate = statusCacheModel.modifiedDate;
		_online = statusCacheModel.online;
		_awake = statusCacheModel.awake;

		if (statusCacheModel.activePanelIds == null) {
			_activePanelIds = "";
		}
		else {
			_activePanelIds = statusCacheModel.activePanelIds;
		}

		if (statusCacheModel.message == null) {
			_message = "";
		}
		else {
			_message = statusCacheModel.message;
		}

		_playSound = statusCacheModel.playSound;
	}
