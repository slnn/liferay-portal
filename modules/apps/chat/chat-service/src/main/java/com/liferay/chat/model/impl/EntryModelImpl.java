...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	...
	void setEntryCacheModel(EntryCacheModel entryCacheModel) {
		...
		_createDate = entryCacheModel.createDate;
		_fromUserId = entryCacheModel.fromUserId;
		_toUserId = entryCacheModel.toUserId;

		if (entryCacheModel.content == null) {
			_content = "";
		}
		else {
			_content = entryCacheModel.content;
		}

		_flag = entryCacheModel.flag;
	}
