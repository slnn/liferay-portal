...
package com.liferay.portal.service.context.factory.impl;
 ...
 * @author Raymond Augé
 */
@Component(service = ServiceContextFactory.class)
public class ServiceContextFactoryImpl implements ServiceContextFactory {
	...
	@Override
	public ServiceContext getInstance(PortletRequest portletRequest)
		throws PortalException {
	...
	public ServiceContext getInstance(
		...
		Map<String, Serializable> expandoBridgeAttributes =
				ExpandoAttributesUtil.getExpandoBridgeAttributes(
	...
	private void _ensureValidModelPermissions(
	...
	private ServiceContext _getInstance(
			HttpServletRequest httpServletRequest)
		throws PortalException {
	...
	private ServiceContext _getInstance(PortletRequest portletRequest)
		throws PortalException {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ServiceContextFactoryImpl.class);
